...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-embedded-software)](https://GitHub.com/iDoka/awesome-embedded-software/stargazers/) ⭐ 1,112 | 🐛 1 | 📅 2026-08-27
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-embedded-software)](https://GitHub.com/iDoka/awesome-embedded-software/network/) ⭐ 1,112 | 🐛 1 | 📅 2026-08-27
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-embedded-software/)](https://GitHub.com/iDoka/awesome-embedded-software/watchers/) ⭐ 1,112 | 🐛 1 | 📅 2026-08-27
...
Permanent URL to this list: <https://github.com/iDoka/awesome-embedded-software> ⭐ 1,112 | 🐛 1 | 📅 2026-08-27
...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,118 | 🐛 59 | 🌐 C++ | 📅 2026-09-14 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [littlefs](https://github.com/littlefs-project/littlefs) ⭐ 6,938 | 🐛 633 | 🌐 C | 📅 2026-03-25 - Little fail-safe filesystem designed for microcontrollers.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 13,038 | 🐛 5 | 🌐 C | 📅 2026-09-15 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) ⭐ 1,092 | 🐛 51 | 🌐 C | 📅 2026-09-10 - Embedded compute library for Cortex-M and Cortex-A.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,957 | 🐛 1,653 | 🌐 C | 📅 2026-09-10 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 5,009 | 🐛 35 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,826 | 🐛 731 | 🌐 C | 📅 2026-09-15 - Heavily optimized cryptography algorithms for embedded Devices.
...
* [micro-ecc](https://github.com/kmackay/micro-ecc) ⭐ 1,436 | 🐛 62 | 🌐 PHP | 📅 2024-11-14 - ECDH and ECDSA for 8-bit, 32-bit, and 64-bit processors.
...
* [LK kernel](https://github.com/littlekernel/lk) ⭐ 3,691 | 🐛 93 | 🌐 C | 📅 2026-09-10 - The Little Kernel Embedded Operating System is SMP-aware kernel designed for small systems ported to a variety of platforms and cpu architectures.
...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,527 | 🐛 3,890 | 🌐 C | 📅 2026-09-15 - New generation, scalable, optimized, secure RTOS for multiple hardware architectures.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,219 | 🐛 490 | 🌐 C | 📅 2026-09-15 - RT-Thread was born in 2006, it is an open source, neutral, and community-based real-time operating system (RTOS). RT-Thread has Standard version and Nano version. For resource-constrained microcontroller (MCU) systems, the NANO kernel version that requires only 3KB Flash and 1.2KB RAM memory resources can be tailored with easy-to-use tools; And for resource-rich IoT devices, RT-Thread can use the on-line software package management tool, together with system configuration tools, to achieve intuitive and rapid modular cutting, seamlessly import rich software packages, thus achieving complex functions like Android's graphical interface and touch sliding effects, smart voice interaction effects, and so on.
* 🔝[FreeRTOS™](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,802 | 🐛 35 | 🌐 C | 📅 2026-08-26 - FreeRTOS.
* [Tock Embedded OS](https://github.com/tock/tock) ⭐ 6,442 | 🐛 219 | 🌐 Rust | 📅 2026-09-15 - Embedded operating system designed for running multiple concurrent, mutually distrustful applications on low-memory and low-power microcontrollers *(Rust)*.
* [RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,800 | 🐛 879 | 🌐 C | 📅 2026-09-15 - Real-time multi-threading operating system that supports a range of devices that are typically found in the Internet of Things (IoT): 8-bit, 16-bit and 32-bit microcontrollers. RIOT is based on the following design principles: energy-efficiency, real-time capabilities, small memory footprint, modularity, and uniform API access, independent of the underlying hardware (this API offers partial POSIX compliance).
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 4,033 | 🐛 757 | 🌐 C | 📅 2026-09-15 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,527 | 🐛 77 | 🌐 C | 📅 2026-09-15 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
* [embox](https://github.com/embox/embox) ⭐ 1,596 | 🐛 217 | 🌐 C | 📅 2026-09-15 - Configurable RTOS designed for resource constrained and embedded systems. Embox main idea is using Linux software without Linux.
...
* [micromenu-v2](https://github.com/abcminiuser/micromenu-v2) ⭐ 83 | 🐛 4 | 🌐 Makefile | 📅 2019-04-26 - Tiny text-orientated menu library in C for embedded use.
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 25,780 | 🐛 10 | 🌐 C++ | 📅 2026-09-15 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,604 | 🐛 50 | 🌐 C++ | 📅 2026-09-05 - Very fast, header-only/compiled, C++ logging library.
...
* [trice](https://github.com/rokath/trice) ⭐ 993 | 🐛 1 | 🌐 Go | 📅 2026-09-15 - Super fast and tiny embedded device C printf-like trace code (works also inside interrupts) and real-time PC logging (trace ID visualization).
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,695 | 🐛 128 | 🌐 C | 📅 2026-09-15 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,678 | 🐛 280 | 🌐 C | 📅 2026-09-14 - U8glib library for monochrome displays, version 2.
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,100 | 🐛 269 | 🌐 C | 📅 2026-09-15 - Cross-platform USB stack for embedded system.
...
* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,113 | 🐛 96 | 🌐 C | 📅 2026-09-15 - Secure boot for 32-bit Microcontrollers.
...
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 534 | 🐛 16 | 🌐 C | 📅 2026-09-14 - Portable, OS-agnostic, secure bootloader for microcontrollers, supporting firmware authentication and firmware update mechanisms.
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,730 | 🐛 554 | 🌐 Go | 📅 2026-09-14 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
* [chibicc](https://github.com/rui314/chibicc) ⭐ 11,891 | 🐛 127 | 🌐 C | 📅 2023-10-30 - Yet another small C compiler that implements most C11 features.
* [lcc](https://github.com/drh/lcc) ⭐ 2,619 | 🐛 44 | 🌐 C | 📅 2024-10-06 - Retargetable ANSI C Compiler (fork for [ULP in ESP32](https://github.com/jasonful/lcc) ⭐ 99 | 🐛 3 | 🌐 C | 📅 2021-05-29).
...
* [modm](https://github.com/modm-io/modm) ⭐ 976 | 🐛 69 | 🌐 C++ | 📅 2026-08-07 - Barebone embedded C++20 library generator for AVR, SAM and ARM Cortex-M Microcontrollers (supported 3534 devices).
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 465 | 🐛 60 | 🌐 C | 📅 2026-09-15 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
...
Please follow [this](https://github.com/iDoka/awesome-embedded-software) ⭐ 1,112 | 🐛 1 | 📅 2026-08-27 root-repo for lastest updates.
