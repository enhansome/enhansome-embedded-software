...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-embedded-software)](https://GitHub.com/iDoka/awesome-embedded-software/stargazers/) ⭐ 1,111 | 🐛 0 | 📅 2026-08-27
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-embedded-software)](https://GitHub.com/iDoka/awesome-embedded-software/network/) ⭐ 1,111 | 🐛 0 | 📅 2026-08-27
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-embedded-software/)](https://GitHub.com/iDoka/awesome-embedded-software/watchers/) ⭐ 1,111 | 🐛 0 | 📅 2026-08-27
...
Permanent URL to this list: <https://github.com/iDoka/awesome-embedded-software> ⭐ 1,111 | 🐛 0 | 📅 2026-08-27
...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,118 | 🐛 57 | 🌐 C++ | 📅 2026-09-13 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [µClibc-ng](https://github.com/wbx-github/uclibc-ng) ⭐ 215 | 🐛 0 | 🌐 C | 📅 2026-09-12 - Embedded C Library.
...
* [FSMLang](https://github.com/FSMLang/FSMLang) ⭐ 10 | 🐛 20 | 🌐 C | 📅 2026-09-10 - State machine description language with C language generator. Supports flat and hierarchical machines and event subsystem.
...
* [umm\_malloc](https://github.com/rhempel/umm_malloc) ⭐ 492 | 🐛 6 | 🌐 C | 📅 2026-06-25 - Memory Manager For Small(ish) Microprocessors.
* [lwmem](https://github.com/MaJerle/lwmem) ⭐ 459 | 🐛 1 | 🌐 C | 📅 2026-09-12 - Lightweight dynamic memory manager library for embedded systems with memory constraints. It implements malloc, calloc, realloc and free functions.
...
* [EmbeddedProto](https://github.com/Embedded-AMS/EmbeddedProto) ⭐ 277 | 🐛 3 | 🌐 C++ | 📅 2026-09-11 -  C++ Protocol Buffers implementation specifically suitable for ARM Cortex-M microcontrollers. It is small, reliable and easy to use.
...
* [LwRB](https://github.com/MaJerle/lwrb) ⭐ 1,534 | 🐛 2 | 🌐 C | 📅 2026-09-12 - Lightweight generic ring buffer manager library.
...
* [littlefs](https://github.com/littlefs-project/littlefs) ⭐ 6,937 | 🐛 633 | 🌐 C | 📅 2026-03-25 - Little fail-safe filesystem designed for microcontrollers.
* [SdFat](https://github.com/greiman/SdFat) ⭐ 1,209 | 🐛 242 | 🌐 C++ | 📅 2025-08-13 - Arduino FAT16/FAT32 exFAT Library.
...
* [FlashDB](https://github.com/armink/FlashDB) ⭐ 2,845 | 🐛 188 | 🌐 C | 📅 2026-08-15 - Ultra-lightweight database that supports key-value and time series data.
...
* [EasyFlash](https://github.com/armink/EasyFlash#1-introduction) ⭐ 2,368 | 🐛 62 | 🌐 C | 📅 2025-03-14 - Lightweight embedded flash memory library.
...
* [nanoPB](https://github.com/nanopb/nanopb) ⭐ 5,560 | 🐛 77 | 🌐 C | 📅 2026-09-08 - Small code-size Protocol Buffers implementation in ANSI C. It is especially suitable for use in microcontrollers, but fits any memory restricted system.
* [nanoMODBUS](https://github.com/debevv/nanoMODBUS) ⭐ 908 | 🐛 38 | 🌐 C | 📅 2026-02-01 - A compact MODBUS RTU/TCP C library for embedded/microcontrollers.
...
* [aem-modbus-simulator](https://github.com/leaberg69/aem-modbus-simulator) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2026-08-30 - Open-source Python Modbus RTU/TCP slave simulator emulating an industrial DC monitor (147 holding registers, 6 baudrates). Useful for testing embedded firmware Modbus master implementations without physical slave hardware on the bench.
...
* [uIP](https://github.com/adamdunkels/uip) ⭐ 1,085 | 🐛 5 | 🌐 C | 📅 2017-01-09 - Very small implementation of the TCP/IP stack that is written by Adam Dunkels.
...
* [LiveKit](https://github.com/livekit/client-sdk-esp32) ⭐ 149 | 🐛 15 | 🌐 C | 📅 2026-09-11 - ESP32 SDK for LiveKit: real-time audio, video, and data streaming.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 13,038 | 🐛 2 | 🌐 C | 📅 2026-09-12 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [Paho MQTT](https://github.com/eclipse/paho.mqtt.embedded-c) ⭐ 1,542 | 🐛 93 | 🌐 C | 📅 2026-07-03 - C client library for embedded systems.
...
* [TinyGSM](https://github.com/vshymanskyy/TinyGSM) ⭐ 2,215 | 🐛 354 | 🌐 C++ | 📅 2026-07-21 - Small Arduino library for GSM modules, that just works.
* [LwGSM](https://github.com/MaJerle/lwgsm) ⭐ 487 | 🐛 22 | 🌐 C | 📅 2026-09-12 - Library for SIMCOM GSM modules to communicate with AT commands and RTOS from host device.
...
* [minmea](https://github.com/kosma/minmea) ⭐ 964 | 🐛 14 | 🌐 C | 📅 2026-07-15 - Lightweight GPS NMEA 0183 parser library in pure C.
* [LwGPS](https://github.com/MaJerle/lwgps) ⭐ 506 | 🐛 4 | 🌐 C | 📅 2026-09-12 - Lightweight GPS NMEA parser for embedded systems.

#### AT command parser

* [LwESP](https://github.com/MaJerle/lwesp) ⭐ 561 | 🐛 7 | 🌐 C | 📅 2026-09-12 - Lightweight ESP AT commands parser library to communicate with ESP8266 or ESP32 Wi-Fi module using AT commands.
* [cAT](https://github.com/marcinbor85/cAT) ⭐ 494 | 🐛 14 | 🌐 C | 📅 2023-12-20 - Plain C library for parsing AT commands for use in host devices.
* [ATParser](https://github.com/ARMmbed/ATParser) ⭐ 39 | 🐛 9 | 🌐 C++ | 📅 2019-10-29 - An mbed-os compatible AT command parser.
...
* [gzat](https://github.com/gzhouct/gzat) ⭐ 2 | 🐛 0 | 🌐 C++ | 📅 2020-08-09 - Portable AT command parsing library in C++ language.

#### Various protocols

* [libCoAP](https://github.com/obgm/libcoap) ⭐ 920 | 🐛 57 | 🌐 C | 📅 2026-09-11 - C implementation of a lightweight application-protocol for devices that are constrained their resources such as computing power, RF range, memory, bandwidth, or network packet sizes. This protocol, CoAP, is standardized by the IETF as RFC 7252.
* [lwpkt](https://github.com/MaJerle/lwpkt) ⭐ 382 | 🐛 3 | 🌐 C | 📅 2026-09-12 - Lightweight packet protocol structure for multi-device communication focused on RS-485.
* [MIN](https://github.com/min-protocol/min) ⭐ 284 | 🐛 25 | 🌐 Python | 📅 2024-01-30 - Microcontroller Interconnect Network protocol version 2.0.
* [lwow](https://github.com/MaJerle/lwow) ⭐ 278 | 🐛 1 | 🌐 C | 📅 2026-09-12 - Lightweight onewire protocol library optimized for UART hardware on embedded systems.
...
* [FPM](https://github.com/MikeLankamp/fpm) ⭐ 840 | 🐛 21 | 🌐 C++ | 📅 2026-03-29 - C++ header-only fixed-point math library.
...
* [liquid-dsp](https://github.com/jgaeddert/liquid-dsp) ⭐ 2,293 | 🐛 163 | 🌐 C | 📅 2026-09-12 - Digital signal processing library for software-defined radios.
* [KISS FFT](https://github.com/mborgerding/kissfft) ⭐ 1,981 | 🐛 40 | 🌐 C | 📅 2026-08-12 - Mixed-radix Fast Fourier Transform based up on the principle, "Keep It Simple, Stupid".
* [CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) ⭐ 1,090 | 🐛 51 | 🌐 C | 📅 2026-09-10 - Embedded compute library for Cortex-M and Cortex-A.
* [iir1](https://github.com/berndporr/iir1) ⭐ 780 | 🐛 0 | 🌐 C++ | 📅 2025-07-07 - DSP IIR realtime filter library written in C++.
* [pocketfft](https://github.com/mreineck/pocketfft) ⭐ 157 | 🐛 6 | 🌐 C++ | 📅 2026-06-30 - Heavily modified implementation of FFTPack.
* [kalman-clib](https://github.com/sunsided/kalman-clib) ⭐ 145 | 🐛 0 | 🌐 C | 📅 2026-06-09 - Microcontroller targeted naive Kalman filter implementation in pure C.
...
* [lsp-dsp-lib](https://github.com/lsp-plugins/lsp-dsp-lib) ⭐ 95 | 🐛 0 | 🌐 C++ | 📅 2026-09-03 - DSP library for digital signal processing provides set of functions that perform SIMD-optimized computing on several hardware architectures. All functions currently operate on IEEE-754 single-precision floating-point numbers.
...
* [heatshrink](https://github.com/atomicobject/heatshrink) ⭐ 1,550 | 🐛 42 | 🌐 C | 📅 2024-05-19 - Data compression library for embedded/real-time systems.
...
* [μTensor](https://github.com/uTensor/uTensor) ⭐ 1,932 | 🐛 56 | 🌐 C++ | 📅 2025-05-10 - TinyML AI inference library.
...
* [TinyMaix](https://github.com/sipeed/TinyMaix) ⭐ 1,072 | 🐛 22 | 🌐 C | 📅 2025-02-05 - A tiny inference Neural Network library specifically for microcontrollers (TinyML). Designed to follow the rule: Easy-to-Use > Portable > Speed > Space.
...
* [edge-agents (ForestHub)](https://github.com/ForestHubAI/edge-agents) ⭐ 102 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - Open-source (AGPL-3.0) 30 MB AI agent runtime for edge devices. Offline by default; GPIO/UART/MQTT as first-class nodes; local SLMs alongside cloud LLMs. Runs on Raspberry Pi, Jetson, STM32MP25.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,956 | 🐛 1,719 | 🌐 C | 📅 2026-09-10 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 5,008 | 🐛 35 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,825 | 🐛 728 | 🌐 C | 📅 2026-09-13 - Heavily optimized cryptography algorithms for embedded Devices.
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,788 | 🐛 59 | 🌐 C | 📅 2026-09-01 - Fairly comprehensive, modular and portable cryptographic toolkit that provides developers with a vast array of well known published block ciphers, one-way hash functions, chaining modes, pseudo-random number generators, public key cryptography and a plethora of other routines.
...
* [LibHydrogen](https://github.com/jedisct1/libhydrogen) ⭐ 785 | 🐛 0 | 🌐 C | 📅 2026-08-26 - Lightweight, secure, easy-to-use crypto library suitable for constrained environments.
* [tlse](https://github.com/eduardsui/tlse) ⭐ 685 | 🐛 36 | 🌐 C | 📅 2026-08-07 - Single C file TLS 1.2/1.3 implementation, using tomcrypt as crypto library.
...
* [trussed](https://github.com/trussed-dev/trussed) ⭐ 503 | 🐛 18 | 🌐 Rust | 📅 2026-07-22 - Minimal, modular way to write cryptographic applications on microcontroller platforms (Rust).
* [arduinolibs](https://github.com/rweather/arduinolibs) ⭐ 476 | 🐛 38 | 🌐 C++ | 📅 2024-05-26 - Arduino Cryptography Library.
* [wolfTPM](https://github.com/wolfSSL/wolfTPM) ⭐ 344 | 🐛 7 | 🌐 C | 📅 2026-09-11 - Highly portable TPM 2.0 library, designed for embedded use.
...
* [micro-ecc](https://github.com/kmackay/micro-ecc) ⭐ 1,435 | 🐛 62 | 🌐 PHP | 📅 2024-11-14 - ECDH and ECDSA for 8-bit, 32-bit, and 64-bit processors.
...
* [pcg-c-basic](https://github.com/imneme/pcg-c-basic) ⭐ 454 | 🐛 18 | 🌐 C | 📅 2023-11-25 - Code provides a minimal implementation of one member of the PCG family of random number generators, which are fast, statistically excellent, and offer a number of useful features.
* [pcg-c](https://github.com/imneme/pcg-c) ⭐ 429 | 🐛 10 | 🌐 C | 📅 2023-10-26 - Code provides an implementation of the PCG family of random number generators, which are fast, statistically excellent, and offer a number of useful features.

## OS

* [LK kernel](https://github.com/littlekernel/lk) ⭐ 3,676 | 🐛 93 | 🌐 C | 📅 2026-09-10 - The Little Kernel Embedded Operating System is SMP-aware kernel designed for small systems ported to a variety of platforms and cpu architectures.
* [QuarkTS](https://github.com/kmilo17pet/QuarkTS) ⭐ 353 | 🐛 4 | 🌐 C | 📅 2025-10-27 - OS for embedded applications that supports prioritized cooperative scheduling, time control, inter-task communications primitives, hierarchical state machines and CoRoutines.
...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,503 | 🐛 3,830 | 🌐 C | 📅 2026-09-13 - New generation, scalable, optimized, secure RTOS for multiple hardware architectures.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,214 | 🐛 491 | 🌐 C | 📅 2026-09-11 - RT-Thread was born in 2006, it is an open source, neutral, and community-based real-time operating system (RTOS). RT-Thread has Standard version and Nano version. For resource-constrained microcontroller (MCU) systems, the NANO kernel version that requires only 3KB Flash and 1.2KB RAM memory resources can be tailored with easy-to-use tools; And for resource-rich IoT devices, RT-Thread can use the on-line software package management tool, together with system configuration tools, to achieve intuitive and rapid modular cutting, seamlessly import rich software packages, thus achieving complex functions like Android's graphical interface and touch sliding effects, smart voice interaction effects, and so on.
* 🔝[FreeRTOS™](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,791 | 🐛 35 | 🌐 C | 📅 2026-08-26 - FreeRTOS.
* [Tock Embedded OS](https://github.com/tock/tock) ⭐ 6,442 | 🐛 214 | 🌐 Rust | 📅 2026-09-13 - Embedded operating system designed for running multiple concurrent, mutually distrustful applications on low-memory and low-power microcontrollers *(Rust)*.
* [RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,800 | 🐛 871 | 🌐 C | 📅 2026-09-13 - Real-time multi-threading operating system that supports a range of devices that are typically found in the Internet of Things (IoT): 8-bit, 16-bit and 32-bit microcontrollers. RIOT is based on the following design principles: energy-efficiency, real-time capabilities, small memory footprint, modularity, and uniform API access, independent of the underlying hardware (this API offers partial POSIX compliance).
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 4,031 | 🐛 761 | 🌐 C | 📅 2026-09-13 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,525 | 🐛 79 | 🌐 C | 📅 2026-09-11 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
* [embox](https://github.com/embox/embox) ⭐ 1,594 | 🐛 216 | 🌐 C | 📅 2026-09-12 - Configurable RTOS designed for resource constrained and embedded systems. Embox main idea is using Linux software without Linux.
* [QP/C](https://github.com/QuantumLeaps/qpc) ⭐ 1,369 | 🐛 4 | 🌐 C | 📅 2026-08-28 - Real-time embedded framework/RTOS for embedded systems based on active objects (actors) and hierarchical state machines (FuSa, MISRA-C 2023 compliance).
* [µC/OS-III](https://github.com/weston-embedded/uC-OS3) ⭐ 1,089 | 🐛 4 | 🌐 C | 📅 2026-07-15 - Preemptive, highly portable, and scalable real-time kernel. Designed for ease of use on a huge number of CPU architectures.
* [MuditaOS](https://github.com/mudita/MuditaOS) ⭐ 941 | 🐛 67 | 🌐 C | 📅 2026-06-13 - Mobile operating system based on FreeRTOS optimized for E Ink displays - developed for Mudita Pure minimalist phone.
* [ChibiOS/RT](https://github.com/ChibiOS/ChibiOS) ⭐ 863 | 🐛 26 | 🌐 C | 📅 2026-05-31 - Compact and fast real-time operating system supporting multiple architectures designed for embedded applications on microcontrollers of 8-, 16-, and 32-bits.
* [µC/OS-II](https://github.com/weston-embedded/uC-OS2) ⭐ 740 | 🐛 3 | 🌐 C | 📅 2023-01-05 - Preemptive, highly portable, and scalable real-time kernels. Designed for ease of use on a huge number of CPU architectures.
...
* [vsf](https://github.com/vsfteam/vsf) ⭐ 338 | 🐛 1 | 🌐 C | 📅 2026-09-10 - Versaloon Software Framework - a tiny preemptive-capable event-driven incremental software framework for Embedded Systems.
* [lwevt](https://github.com/MaJerle/lwevt) ⭐ 198 | 🐛 0 | 🌐 C | 📅 2026-09-12 - Lightweight event management system for embedded systems.
...
* [microshell](https://github.com/marcinbor85/microshell) ⭐ 364 | 🐛 9 | 🌐 C | 📅 2024-06-20 - Lightweight pure C implementation of virtual shell, compatible with VT100 terminal. Support root tree, run-time mounting paths, global commands, and much more.
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 25,762 | 🐛 10 | 🌐 C++ | 📅 2026-09-13 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
* [tiny-printf](https://github.com/mpaland/printf) ⭐ 3,058 | 🐛 66 | 🌐 C | 📅 2023-04-03 - Tiny, fast, non-dependent and fully loaded printf implementation for embedded systems. Extensive test suite passing.
* [nanoprintf](https://github.com/charlesnicholson/nanoprintf) ⭐ 849 | 🐛 7 | 🌐 C++ | 📅 2026-09-07 - The smallest public printf implementation for its feature set.
* [tiny-printf new](https://github.com/eyalroz/printf) ⭐ 640 | 🐛 13 | 🌐 C | 📅 2026-09-09 - Enhanced and maintained fork of `tiny-printf`. Tiny, fast(ish), self-contained and fully loaded printf, sprinf etc.
* [lwprintf](https://github.com/MaJerle/lwprintf) ⭐ 345 | 🐛 3 | 🌐 C | 📅 2026-09-12 - Lightweight printf library optimized for embedded systems.
...
* [Embedded\_Printf](https://github.com/agaelema/Embedded_Printf) ⭐ 7 | 🐛 0 | 🌐 C | 📅 2026-09-12 - Embedded version of the famous "printf( )" function. The idea is create an simple and efficient library to meet some common needs in embedded systems.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,596 | 🐛 47 | 🌐 C++ | 📅 2026-09-05 - Very fast, header-only/compiled, C++ logging library.
* [EasyLogger](https://github.com/armink/EasyLogger) ⭐ 4,746 | 🐛 81 | 🌐 C | 📅 2026-08-13 - Ultra-lightweight (ROM<1.6K, RAM<0.3k), high-performance C/C++ log library.
* [trice](https://github.com/rokath/trice) ⭐ 993 | 🐛 0 | 🌐 Go | 📅 2026-09-13 - Super fast and tiny embedded device C printf-like trace code (works also inside interrupts) and real-time PC logging (trace ID visualization).
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,679 | 🐛 131 | 🌐 C | 📅 2026-09-13 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,677 | 🐛 279 | 🌐 C | 📅 2026-08-23 - U8glib library for monochrome displays, version 2.
* [LovyanGFX](https://github.com/lovyan03/LovyanGFX/) ⭐ 1,758 | 🐛 16 | 🌐 C | 📅 2026-09-12 - Display (LCD / OLED / EPD) graphics library (for ESP32 SPI, I2C, 8bitParallel / ESP8266 SPI, I2C / RP2040 SPI / ATSAMD51 SPI and more).
* [UGUI (µGUI)](https://github.com/achimdoebler/UGUI) ⭐ 1,394 | 🐛 43 | 🌐 C | 📅 2023-10-29 - A graphic library. It supports color, grayscale, monochrome and multiple displays, touch screen, windows and objects, basic geometric primitives, fonts, console. There is no required dynamic allocation and memory for screen buffer. Documentation available on [developer's website](https://embeddedlightning.com/download/%c2%b5gui-v0-3/).
* [Embedded-graphics](https://github.com/embedded-graphics/embedded-graphics) ⭐ 1,339 | 🐛 90 | 🌐 Rust | 📅 2026-08-02 - 2D graphics library that is focused on memory constrained embedded devices to draw graphics without using any buffers (Rust).
...
* [GUIX](https://github.com/azure-rtos/guix) ⭐ 406 | 🐛 25 | 🌐 C | 📅 2026-08-28 - Provides a complete, embedded graphical user interface (GUI) library and design environment, facilitating the creation and maintenance of all graphical elements needed by your device.
...
* [ESLowGraphics](https://github.com/errorcalc/ESLowGraphicsLibrary) ⭐ 20 | 🐛 2 | 🌐 C | 📅 2018-04-07 - Low level software graphics library by ErrorSoft (ESLGL).
...
* [ttf2mesh](https://github.com/fetisov/ttf2mesh) ⭐ 235 | 🐛 12 | 🌐 C++ | 📅 2024-06-26 - Library for TrueType font tessellation. Allows to convert font glyphs to mesh objects without rasterization.
...
* [lcd-image-converter](https://github.com/riuson/lcd-image-converter) ⭐ 405 | 🐛 6 | 🌐 C++ | 📅 2025-12-26 - Tool to create bitmaps and fonts for embedded applications; allows you to create bitmaps and fonts, and transform them to "C" source format for embedded applications.
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,091 | 🐛 269 | 🌐 C | 📅 2026-09-13 - Cross-platform USB stack for embedded system.
* [libusb\_stm32](https://github.com/dmitrystu/libusb_stm32) ⭐ 829 | 🐛 29 | 🌐 C | 📅 2025-10-06 - Lightweight USB device Stack for STM32 microcontrollers.
* [CherryUSB](https://github.com/CherryUSB) - Tiny, beautiful and portable USB host and device stack for embedded system with USB.

### Flash

* [SFUD](https://github.com/armink/SFUD) ⭐ 1,718 | 🐛 33 | 🌐 C | 📅 2025-05-30 - Serial Flash Universal Driver (using JEDEC's SFDP standard serial (SPI) flash universal driver library).

### CAN bus

* [CanBoot](https://github.com/Arksine/CanBoot) ⭐ 675 | 🐛 82 | 🌐 C | 📅 2026-03-20 -  Can Bootloader for MCUs (Currently lpc176x, stm32 and rp2040 MCUs are supported).
* [libcanard](https://github.com/UAVCAN/libcanard) ⭐ 448 | 🐛 0 | 🌐 C | 📅 2026-07-02 - Compact implementation of the UAVCAN/CAN protocol in C for high-integrity real-time embedded systems.
...
* [stm32-async-1wire](https://github.com/a5021/stm32-async-1wire) ⭐ 11 | 🐛 0 | 🌐 C | 📅 2026-09-13 - Non-blocking, register-level 1-Wire master for STM32 (DS18B20 temperature driver on top). Hardware-timed (TIM1+DMA, DMAMUX on G0), interrupt-free, RTOS-agnostic; header-only backends for STM32F1/F0/G0; hardware-validated on Blue Pill (F103) and STM32G031; strong-pull-up parasite powering; released v1.6.1.

## Others

### Thread management

* [C-Thread-Pool](https://github.com/Pithikos/C-Thread-Pool) ⭐ 2,364 | 🐛 29 | 🌐 C | 📅 2025-05-18 - Minimal but powerful thread pool in ANSI C.

### Bootloaders

* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,105 | 🐛 96 | 🌐 C | 📅 2026-09-11 - Secure boot for 32-bit Microcontrollers.
* [OpenBLT](https://github.com/feaser/openblt) ⭐ 970 | 🐛 0 | 🌐 C | 📅 2026-07-14 - Open source bootloader for STM32, XMC, HCS12 and other microcontroller targets. It supports communication interfaces such as: RS232, CAN, USB, TCP/IP and it ships with the easy-to-use [MicroBoot](https://www.feaser.com/openblt/doku.php?id=manual:microboot) PC tool for initiating and monitoring the firmware update. Performing firmware updates directly from an SD-card is also supported.
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 534 | 🐛 13 | 🌐 C | 📅 2026-09-10 - Portable, OS-agnostic, secure bootloader for microcontrollers, supporting firmware authentication and firmware update mechanisms.
* [TinyUF2](https://github.com/adafruit/tinyuf2) ⭐ 471 | 🐛 14 | 🌐 C | 📅 2026-08-13 - Bootloader based on TinyUSB for embedded devices such as ESP32, STM32 and iMX RT10xx.

### Firmware updates

* [SWupdate](https://github.com/sbabic/swupdate) ⭐ 1,867 | 🐛 11 | 🌐 C | 📅 2026-08-19 - Software Update for Embedded Linux Devices to update system in field. SWUpdate supports local and OTA updates, multiple update strategies and it is designed with security in mind.
* [UF2](https://github.com/microsoft/uf2) ⭐ 1,033 | 🐛 24 | 🌐 JavaScript | 📅 2026-02-08 - USB Flashing Format specification for flashing microcontrollers over MSC (Mass Storage Class; aka removable flash drive).

### Touch Screen

* [tslib](https://github.com/libts/tslib) ⭐ 675 | 🐛 42 | 🌐 C | 📅 2025-11-05 - Touchscreen access library.
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,725 | 🐛 555 | 🌐 Go | 📅 2026-09-13 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
* [chibicc](https://github.com/rui314/chibicc) ⭐ 11,887 | 🐛 127 | 🌐 C | 📅 2023-10-30 - Yet another small C compiler that implements most C11 features.
* [lcc](https://github.com/drh/lcc) ⭐ 2,619 | 🐛 43 | 🌐 C | 📅 2024-10-06 - Retargetable ANSI C Compiler (fork for [ULP in ESP32](https://github.com/jasonful/lcc) ⭐ 99 | 🐛 3 | 🌐 C | 📅 2021-05-29).
* [pcc](http://pcc.ludd.ltu.se/) - Portable C Compiler ([mirror](https://github.com/IanHarvey/pcc) ⭐ 138 | 🐛 4 | 🌐 C | 📅 2024-08-01).
* [rvcc](https://github.com/mausimus/rvcc) ⭐ 101 | 🐛 0 | 🌐 C | 📅 2024-05-01 - Bootstrapped C compiler for 32-bit RISC-V and ARM ISAs (generates executable Linux ELF binaries for RV32IM and ARMv7).
...
* [modm](https://github.com/modm-io/modm) ⭐ 975 | 🐛 68 | 🌐 C++ | 📅 2026-08-07 - Barebone embedded C++20 library generator for AVR, SAM and ARM Cortex-M Microcontrollers (supported 3534 devices).
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 465 | 🐛 67 | 🌐 C | 📅 2026-09-13 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
* [WTX](https://github.com/c410-f3r/wtx) ⭐ 400 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 - A set of web-oriented tools.
...
Please follow [this](https://github.com/iDoka/awesome-embedded-software) ⭐ 1,111 | 🐛 0 | 📅 2026-08-27 root-repo for lastest updates.
