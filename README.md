...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-embedded-software)](https://GitHub.com/iDoka/awesome-embedded-software/stargazers/) ⭐ 1,111 | 🐛 1 | 📅 2026-08-27
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-embedded-software)](https://GitHub.com/iDoka/awesome-embedded-software/network/) ⭐ 1,111 | 🐛 1 | 📅 2026-08-27
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-embedded-software/)](https://GitHub.com/iDoka/awesome-embedded-software/watchers/) ⭐ 1,111 | 🐛 1 | 📅 2026-08-27
...
Permanent URL to this list: <https://github.com/iDoka/awesome-embedded-software> ⭐ 1,111 | 🐛 1 | 📅 2026-08-27
...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,118 | 🐛 58 | 🌐 C++ | 📅 2026-09-14 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [littlefs](https://github.com/littlefs-project/littlefs) ⭐ 6,939 | 🐛 633 | 🌐 C | 📅 2026-03-25 - Little fail-safe filesystem designed for microcontrollers.
...
* [nanoPB](https://github.com/nanopb/nanopb) ⭐ 5,563 | 🐛 77 | 🌐 C | 📅 2026-09-08 - Small code-size Protocol Buffers implementation in ANSI C. It is especially suitable for use in microcontrollers, but fits any memory restricted system.
* [nanoMODBUS](https://github.com/debevv/nanoMODBUS) ⭐ 907 | 🐛 38 | 🌐 C | 📅 2026-02-01 - A compact MODBUS RTU/TCP C library for embedded/microcontrollers.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 13,039 | 🐛 3 | 🌐 C | 📅 2026-09-14 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [LwESP](https://github.com/MaJerle/lwesp) ⭐ 561 | 🐛 7 | 🌐 C | 📅 2026-09-13 - Lightweight ESP AT commands parser library to communicate with ESP8266 or ESP32 Wi-Fi module using AT commands.
...
* [libCoAP](https://github.com/obgm/libcoap) ⭐ 920 | 🐛 50 | 🌐 C | 📅 2026-09-14 - C implementation of a lightweight application-protocol for devices that are constrained their resources such as computing power, RF range, memory, bandwidth, or network packet sizes. This protocol, CoAP, is standardized by the IETF as RFC 7252.
...
* [liquid-dsp](https://github.com/jgaeddert/liquid-dsp) ⭐ 2,294 | 🐛 163 | 🌐 C | 📅 2026-09-12 - Digital signal processing library for software-defined radios.
...
* [CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) ⭐ 1,091 | 🐛 51 | 🌐 C | 📅 2026-09-10 - Embedded compute library for Cortex-M and Cortex-A.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,956 | 🐛 1,649 | 🌐 C | 📅 2026-09-10 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 5,008 | 🐛 35 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,826 | 🐛 724 | 🌐 C | 📅 2026-09-14 - Heavily optimized cryptography algorithms for embedded Devices.
...
* [wolfTPM](https://github.com/wolfSSL/wolfTPM) ⭐ 344 | 🐛 6 | 🌐 C | 📅 2026-09-14 - Highly portable TPM 2.0 library, designed for embedded use.
...
* [LK kernel](https://github.com/littlekernel/lk) ⭐ 3,686 | 🐛 93 | 🌐 C | 📅 2026-09-10 - The Little Kernel Embedded Operating System is SMP-aware kernel designed for small systems ported to a variety of platforms and cpu architectures.
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 4,033 | 🐛 771 | 🌐 C | 📅 2026-09-14 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,527 | 🐛 80 | 🌐 C | 📅 2026-09-11 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
* [embox](https://github.com/embox/embox) ⭐ 1,594 | 🐛 218 | 🌐 C | 📅 2026-09-14 - Configurable RTOS designed for resource constrained and embedded systems. Embox main idea is using Linux software without Linux.
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 25,774 | 🐛 9 | 🌐 C++ | 📅 2026-09-13 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
* [tiny-printf](https://github.com/mpaland/printf) ⭐ 3,059 | 🐛 66 | 🌐 C | 📅 2023-04-03 - Tiny, fast, non-dependent and fully loaded printf implementation for embedded systems. Extensive test suite passing.
...
* [lwprintf](https://github.com/MaJerle/lwprintf) ⭐ 345 | 🐛 3 | 🌐 C | 📅 2026-09-13 - Lightweight printf library optimized for embedded systems.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,598 | 🐛 48 | 🌐 C++ | 📅 2026-09-05 - Very fast, header-only/compiled, C++ logging library.
* [EasyLogger](https://github.com/armink/EasyLogger) ⭐ 4,747 | 🐛 81 | 🌐 C | 📅 2026-08-13 - Ultra-lightweight (ROM<1.6K, RAM<0.3k), high-performance C/C++ log library.
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,685 | 🐛 131 | 🌐 C | 📅 2026-09-14 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,680 | 🐛 280 | 🌐 C | 📅 2026-09-14 - U8glib library for monochrome displays, version 2.
* [LovyanGFX](https://github.com/lovyan03/LovyanGFX/) ⭐ 1,760 | 🐛 15 | 🌐 C | 📅 2026-09-14 - Display (LCD / OLED / EPD) graphics library (for ESP32 SPI, I2C, 8bitParallel / ESP8266 SPI, I2C / RP2040 SPI / ATSAMD51 SPI and more).
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,092 | 🐛 267 | 🌐 C | 📅 2026-09-14 - Cross-platform USB stack for embedded system.
...
* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,109 | 🐛 96 | 🌐 C | 📅 2026-09-11 - Secure boot for 32-bit Microcontrollers.
...
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 534 | 🐛 12 | 🌐 C | 📅 2026-09-14 - Portable, OS-agnostic, secure bootloader for microcontrollers, supporting firmware authentication and firmware update mechanisms.
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,729 | 🐛 553 | 🌐 Go | 📅 2026-09-14 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
...
* [lcc](https://github.com/drh/lcc) ⭐ 2,618 | 🐛 43 | 🌐 C | 📅 2024-10-06 - Retargetable ANSI C Compiler (fork for [ULP in ESP32](https://github.com/jasonful/lcc) ⭐ 99 | 🐛 3 | 🌐 C | 📅 2021-05-29).
...
* [modm](https://github.com/modm-io/modm) ⭐ 976 | 🐛 68 | 🌐 C++ | 📅 2026-08-07 - Barebone embedded C++20 library generator for AVR, SAM and ARM Cortex-M Microcontrollers (supported 3534 devices).
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 465 | 🐛 66 | 🌐 C | 📅 2026-09-14 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
...
Please follow [this](https://github.com/iDoka/awesome-embedded-software) ⭐ 1,111 | 🐛 1 | 📅 2026-08-27 root-repo for lastest updates.
