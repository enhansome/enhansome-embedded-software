...
* [µClibc-ng](https://github.com/wbx-github/uclibc-ng) ⭐ 212 | 🐛 1 | 🌐 C | 📅 2026-08-11 - Embedded C Library.
...
* [FSMLang](https://github.com/FSMLang/FSMLang) ⭐ 10 | 🐛 19 | 🌐 C | 📅 2026-08-12 - State machine description language with C language generator. Supports flat and hierarchical machines and event subsystem.
...
* [lwmem](https://github.com/MaJerle/lwmem) ⭐ 454 | 🐛 1 | 🌐 C | 📅 2026-08-15 - Lightweight dynamic memory manager library for embedded systems with memory constraints. It implements malloc, calloc, realloc and free functions.
* [o1heap](https://github.com/pavel-kirienko/o1heap) ⭐ 414 | 🐛 4 | 🌐 C++ | 📅 2026-02-09 - A highly deterministic constant-complexity memory allocator designed for hard real-time high-integrity embedded systems.
...
* [LwRB](https://github.com/MaJerle/lwrb) ⭐ 1,520 | 🐛 2 | 🌐 C | 📅 2026-08-15 - Lightweight generic ring buffer manager library.
...
* [FlashDB](https://github.com/armink/FlashDB) ⭐ 2,819 | 🐛 193 | 🌐 C | 📅 2026-08-15 - Ultra-lightweight database that supports key-value and time series data.
...
* [EasyFlash](https://github.com/armink/EasyFlash#1-introduction) ⭐ 2,359 | 🐛 61 | 🌐 C | 📅 2025-03-14 - Lightweight embedded flash memory library.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 12,992 | 🐛 4 | 🌐 C | 📅 2026-08-15 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [LwGPS](https://github.com/MaJerle/lwgps) ⭐ 506 | 🐛 4 | 🌐 C | 📅 2026-08-15 - Lightweight GPS NMEA parser for embedded systems.
...
* [cAT](https://github.com/marcinbor85/cAT) ⭐ 492 | 🐛 14 | 🌐 C | 📅 2023-12-20 - Plain C library for parsing AT commands for use in host devices.
...
* [libCoAP](https://github.com/obgm/libcoap) ⭐ 918 | 🐛 67 | 🌐 C | 📅 2026-08-15 - C implementation of a lightweight application-protocol for devices that are constrained their resources such as computing power, RF range, memory, bandwidth, or network packet sizes. This protocol, CoAP, is standardized by the IETF as RFC 7252.
...
* [CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) ⭐ 1,070 | 🐛 39 | 🌐 C | 📅 2026-08-14 - Embedded compute library for Cortex-M and Cortex-A.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,871 | 🐛 1,729 | 🌐 C | 📅 2026-08-14 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 4,996 | 🐛 34 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,806 | 🐛 714 | 🌐 C | 📅 2026-08-15 - Heavily optimized cryptography algorithms for embedded Devices.
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,785 | 🐛 49 | 🌐 C | 📅 2026-08-08 - Fairly comprehensive, modular and portable cryptographic toolkit that provides developers with a vast array of well known published block ciphers, one-way hash functions, chaining modes, pseudo-random number generators, public key cryptography and a plethora of other routines.
...
* [wolfTPM](https://github.com/wolfSSL/wolfTPM) ⭐ 336 | 🐛 2 | 🌐 C | 📅 2026-08-14 - Highly portable TPM 2.0 library, designed for embedded use.
...
* [LK kernel](https://github.com/littlekernel/lk) ⭐ 3,662 | 🐛 100 | 🌐 C | 📅 2026-08-15 - The Little Kernel Embedded Operating System is SMP-aware kernel designed for small systems ported to a variety of platforms and cpu architectures.
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 3,995 | 🐛 758 | 🌐 C | 📅 2026-08-15 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,503 | 🐛 93 | 🌐 C | 📅 2026-08-14 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
* [embox](https://github.com/embox/embox) ⭐ 1,583 | 🐛 216 | 🌐 C | 📅 2026-08-13 - Configurable RTOS designed for resource constrained and embedded systems. Embox main idea is using Linux software without Linux.
...
* [µC/OS-II](https://github.com/weston-embedded/uC-OS2) ⭐ 734 | 🐛 3 | 🌐 C | 📅 2023-01-05 - Preemptive, highly portable, and scalable real-time kernels. Designed for ease of use on a huge number of CPU architectures.
...
* [lwevt](https://github.com/MaJerle/lwevt) ⭐ 196 | 🐛 0 | 🌐 C | 📅 2026-08-15 - Lightweight event management system for embedded systems.
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 23,742 | 🐛 9 | 🌐 C++ | 📅 2026-08-13 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
...
* [lwprintf](https://github.com/MaJerle/lwprintf) ⭐ 344 | 🐛 3 | 🌐 C | 📅 2026-08-15 - Lightweight printf library optimized for embedded systems.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,482 | 🐛 49 | 🌐 C++ | 📅 2026-08-08 - Very fast, header-only/compiled, C++ logging library.
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,392 | 🐛 223 | 🌐 C | 📅 2026-08-13 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,632 | 🐛 288 | 🌐 C | 📅 2026-06-27 - U8glib library for monochrome displays, version 2.
* [LovyanGFX](https://github.com/lovyan03/LovyanGFX/) ⭐ 1,730 | 🐛 16 | 🌐 C | 📅 2026-08-15 - Display (LCD / OLED / EPD) graphics library (for ESP32 SPI, I2C, 8bitParallel / ESP8266 SPI, I2C / RP2040 SPI / ATSAMD51 SPI and more).
...
* [mcufont](https://github.com/mcufont/mcufont) ⭐ 417 | 🐛 4 | 🌐 C | 📅 2026-07-25 - A font rendering library for microcontrollers.
...
* [lcd-image-converter](https://github.com/riuson/lcd-image-converter) ⭐ 407 | 🐛 6 | 🌐 C++ | 📅 2025-12-26 - Tool to create bitmaps and fonts for embedded applications; allows you to create bitmaps and fonts, and transform them to "C" source format for embedded applications.
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,037 | 🐛 240 | 🌐 C | 📅 2026-08-15 - Cross-platform USB stack for embedded system.
...
* [SFUD](https://github.com/armink/SFUD) ⭐ 1,708 | 🐛 33 | 🌐 C | 📅 2025-05-30 - Serial Flash Universal Driver (using JEDEC's SFDP standard serial (SPI) flash universal driver library).
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,648 | 🐛 568 | 🌐 Go | 📅 2026-08-14 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
...
* [lcc](https://github.com/drh/lcc) ⭐ 2,602 | 🐛 43 | 🌐 C | 📅 2024-10-06 - Retargetable ANSI C Compiler (fork for [ULP in ESP32](https://github.com/jasonful/lcc) ⭐ 99 | 🐛 3 | 🌐 C | 📅 2021-05-29).
...
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 453 | 🐛 69 | 🌐 C | 📅 2026-08-15 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
* [WTX](https://github.com/c410-f3r/wtx) ⭐ 394 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - A set of web-oriented tools.
