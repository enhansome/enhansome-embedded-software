...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,106 | 🐛 61 | 🌐 C++ | 📅 2026-08-24 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [LwRB](https://github.com/MaJerle/lwrb) ⭐ 1,523 | 🐛 2 | 🌐 C | 📅 2026-08-21 - Lightweight generic ring buffer manager library.
...
* [nanoPB](https://github.com/nanopb/nanopb) ⭐ 5,537 | 🐛 79 | 🌐 C | 📅 2026-08-24 - Small code-size Protocol Buffers implementation in ANSI C. It is especially suitable for use in microcontrollers, but fits any memory restricted system.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 13,007 | 🐛 2 | 🌐 C | 📅 2026-08-24 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [minmea](https://github.com/kosma/minmea) ⭐ 959 | 🐛 14 | 🌐 C | 📅 2026-07-15 - Lightweight GPS NMEA 0183 parser library in pure C.
...
* [libCoAP](https://github.com/obgm/libcoap) ⭐ 918 | 🐛 55 | 🌐 C | 📅 2026-08-24 - C implementation of a lightweight application-protocol for devices that are constrained their resources such as computing power, RF range, memory, bandwidth, or network packet sizes. This protocol, CoAP, is standardized by the IETF as RFC 7252.
...
* [edge-agents (ForestHub)](https://github.com/ForestHubAI/edge-agents) ⭐ 99 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - Open-source (AGPL-3.0) 30 MB AI agent runtime for edge devices. Offline by default; GPIO/UART/MQTT as first-class nodes; local SLMs alongside cloud LLMs. Runs on Raspberry Pi, Jetson, STM32MP25.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,908 | 🐛 1,726 | 🌐 C | 📅 2026-08-20 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 4,999 | 🐛 33 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,812 | 🐛 732 | 🌐 C | 📅 2026-08-24 - Heavily optimized cryptography algorithms for embedded Devices.
...
* [wolfTPM](https://github.com/wolfSSL/wolfTPM) ⭐ 339 | 🐛 2 | 🌐 C | 📅 2026-08-21 - Highly portable TPM 2.0 library, designed for embedded use.
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 4,004 | 🐛 753 | 🌐 C | 📅 2026-08-25 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 23,759 | 🐛 15 | 🌐 C++ | 📅 2026-08-23 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
...
* [EasyLogger](https://github.com/armink/EasyLogger) ⭐ 4,726 | 🐛 81 | 🌐 C | 📅 2026-08-13 - Ultra-lightweight (ROM<1.6K, RAM<0.3k), high-performance C/C++ log library.
* [trice](https://github.com/rokath/trice) ⭐ 982 | 🐛 1 | 🌐 Go | 📅 2026-08-22 - Super fast and tiny embedded device C printf-like trace code (works also inside interrupts) and real-time PC logging (trace ID visualization).
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,471 | 🐛 220 | 🌐 C | 📅 2026-08-24 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,051 | 🐛 246 | 🌐 C | 📅 2026-08-25 - Cross-platform USB stack for embedded system.
...
* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,043 | 🐛 103 | 🌐 C | 📅 2026-08-13 - Secure boot for 32-bit Microcontrollers.
...
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 526 | 🐛 11 | 🌐 C | 📅 2026-08-24 - Portable, OS-agnostic, secure bootloader for microcontrollers, supporting firmware authentication and firmware update mechanisms.
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,668 | 🐛 562 | 🌐 Go | 📅 2026-08-24 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
...
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 458 | 🐛 59 | 🌐 C | 📅 2026-08-25 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
