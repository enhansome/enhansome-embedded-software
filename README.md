...
[![GitHub stars](https://badgen.net/github/stars/iDoka/awesome-embedded-software)](https://GitHub.com/iDoka/awesome-embedded-software/stargazers/) ⭐ 1,109 | 🐛 0 | 📅 2026-08-27
[![GitHub forks](https://badgen.net/github/forks/iDoka/awesome-embedded-software)](https://GitHub.com/iDoka/awesome-embedded-software/network/) ⭐ 1,109 | 🐛 0 | 📅 2026-08-27
[![GitHub watchers](https://badgen.net/github/watchers/iDoka/awesome-embedded-software/)](https://GitHub.com/iDoka/awesome-embedded-software/watchers/) ⭐ 1,109 | 🐛 0 | 📅 2026-08-27
...
Permanent URL to this list: <https://github.com/iDoka/awesome-embedded-software> ⭐ 1,109 | 🐛 0 | 📅 2026-08-27
...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,117 | 🐛 61 | 🌐 C++ | 📅 2026-09-07 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [umm\_malloc](https://github.com/rhempel/umm_malloc) ⭐ 491 | 🐛 6 | 🌐 C | 📅 2026-06-25 - Memory Manager For Small(ish) Microprocessors.
...
* [littlefs](https://github.com/littlefs-project/littlefs) ⭐ 6,926 | 🐛 633 | 🌐 C | 📅 2026-03-25 - Little fail-safe filesystem designed for microcontrollers.
...
* [FlashDB](https://github.com/armink/FlashDB) ⭐ 2,841 | 🐛 191 | 🌐 C | 📅 2026-08-15 - Ultra-lightweight database that supports key-value and time series data.
...
* [nanoPB](https://github.com/nanopb/nanopb) ⭐ 5,551 | 🐛 80 | 🌐 C | 📅 2026-09-01 - Small code-size Protocol Buffers implementation in ANSI C. It is especially suitable for use in microcontrollers, but fits any memory restricted system.
* [nanoMODBUS](https://github.com/debevv/nanoMODBUS) ⭐ 907 | 🐛 37 | 🌐 C | 📅 2026-02-01 - A compact MODBUS RTU/TCP C library for embedded/microcontrollers.
* [TinyFrame](https://github.com/MightyPork/TinyFrame) ⭐ 434 | 🐛 10 | 🌐 C | 📅 2022-08-26 - Simple library for building and parsing data frames for serial interfaces (like UART / RS232).
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 13,033 | 🐛 0 | 🌐 C | 📅 2026-09-07 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [libCoAP](https://github.com/obgm/libcoap) ⭐ 919 | 🐛 60 | 🌐 C | 📅 2026-09-07 - C implementation of a lightweight application-protocol for devices that are constrained their resources such as computing power, RF range, memory, bandwidth, or network packet sizes. This protocol, CoAP, is standardized by the IETF as RFC 7252.
* [lwpkt](https://github.com/MaJerle/lwpkt) ⭐ 381 | 🐛 3 | 🌐 C | 📅 2026-08-21 - Lightweight packet protocol structure for multi-device communication focused on RS-485.
...
* [FPM](https://github.com/MikeLankamp/fpm) ⭐ 838 | 🐛 21 | 🌐 C++ | 📅 2026-03-29 - C++ header-only fixed-point math library.
...
* [CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) ⭐ 1,079 | 🐛 55 | 🌐 C | 📅 2026-08-14 - Embedded compute library for Cortex-M and Cortex-A.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,947 | 🐛 1,720 | 🌐 C | 📅 2026-09-03 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 5,006 | 🐛 35 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,824 | 🐛 726 | 🌐 C | 📅 2026-09-07 - Heavily optimized cryptography algorithms for embedded Devices.
...
* [LibHydrogen](https://github.com/jedisct1/libhydrogen) ⭐ 782 | 🐛 0 | 🌐 C | 📅 2026-08-26 - Lightweight, secure, easy-to-use crypto library suitable for constrained environments.
...
* [wolfTPM](https://github.com/wolfSSL/wolfTPM) ⭐ 343 | 🐛 6 | 🌐 C | 📅 2026-09-02 - Highly portable TPM 2.0 library, designed for embedded use.
...
* [pcg-c](https://github.com/imneme/pcg-c) ⭐ 425 | 🐛 10 | 🌐 C | 📅 2023-10-26 - Code provides an implementation of the PCG family of random number generators, which are fast, statistically excellent, and offer a number of useful features.
...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,432 | 🐛 3,890 | 🌐 C | 📅 2026-09-07 - New generation, scalable, optimized, secure RTOS for multiple hardware architectures.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,200 | 🐛 493 | 🌐 C | 📅 2026-09-07 - RT-Thread was born in 2006, it is an open source, neutral, and community-based real-time operating system (RTOS). RT-Thread has Standard version and Nano version. For resource-constrained microcontroller (MCU) systems, the NANO kernel version that requires only 3KB Flash and 1.2KB RAM memory resources can be tailored with easy-to-use tools; And for resource-rich IoT devices, RT-Thread can use the on-line software package management tool, together with system configuration tools, to achieve intuitive and rapid modular cutting, seamlessly import rich software packages, thus achieving complex functions like Android's graphical interface and touch sliding effects, smart voice interaction effects, and so on.
* 🔝[FreeRTOS™](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,771 | 🐛 35 | 🌐 C | 📅 2026-08-26 - FreeRTOS.
* [Tock Embedded OS](https://github.com/tock/tock) ⭐ 6,434 | 🐛 207 | 🌐 Rust | 📅 2026-09-04 - Embedded operating system designed for running multiple concurrent, mutually distrustful applications on low-memory and low-power microcontrollers *(Rust)*.
* [RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,785 | 🐛 871 | 🌐 C | 📅 2026-09-07 - Real-time multi-threading operating system that supports a range of devices that are typically found in the Internet of Things (IoT): 8-bit, 16-bit and 32-bit microcontrollers. RIOT is based on the following design principles: energy-efficiency, real-time capabilities, small memory footprint, modularity, and uniform API access, independent of the underlying hardware (this API offers partial POSIX compliance).
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 4,023 | 🐛 753 | 🌐 C | 📅 2026-09-07 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,525 | 🐛 108 | 🌐 C | 📅 2026-09-03 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
* [embox](https://github.com/embox/embox) ⭐ 1,594 | 🐛 216 | 🌐 C | 📅 2026-09-07 - Configurable RTOS designed for resource constrained and embedded systems. Embox main idea is using Linux software without Linux.
* [QP/C](https://github.com/QuantumLeaps/qpc) ⭐ 1,366 | 🐛 4 | 🌐 C | 📅 2026-08-28 - Real-time embedded framework/RTOS for embedded systems based on active objects (actors) and hierarchical state machines (FuSa, MISRA-C 2023 compliance).
...
* [µC/OS-II](https://github.com/weston-embedded/uC-OS2) ⭐ 737 | 🐛 3 | 🌐 C | 📅 2023-01-05 - Preemptive, highly portable, and scalable real-time kernels. Designed for ease of use on a huge number of CPU architectures.
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 25,644 | 🐛 13 | 🌐 C++ | 📅 2026-09-07 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
...
* [nanoprintf](https://github.com/charlesnicholson/nanoprintf) ⭐ 846 | 🐛 8 | 🌐 C++ | 📅 2026-09-02 - The smallest public printf implementation for its feature set.
* [tiny-printf new](https://github.com/eyalroz/printf) ⭐ 639 | 🐛 13 | 🌐 C | 📅 2026-06-27 - Enhanced and maintained fork of `tiny-printf`. Tiny, fast(ish), self-contained and fully loaded printf, sprinf etc.
...
* [EasyLogger](https://github.com/armink/EasyLogger) ⭐ 4,742 | 🐛 81 | 🌐 C | 📅 2026-08-13 - Ultra-lightweight (ROM<1.6K, RAM<0.3k), high-performance C/C++ log library.
* [trice](https://github.com/rokath/trice) ⭐ 990 | 🐛 0 | 🌐 Go | 📅 2026-09-06 - Super fast and tiny embedded device C printf-like trace code (works also inside interrupts) and real-time PC logging (trace ID visualization).
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,631 | 🐛 138 | 🌐 C | 📅 2026-09-07 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,668 | 🐛 280 | 🌐 C | 📅 2026-08-23 - U8glib library for monochrome displays, version 2.
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,084 | 🐛 257 | 🌐 C | 📅 2026-09-07 - Cross-platform USB stack for embedded system.
...
* [SFUD](https://github.com/armink/SFUD) ⭐ 1,716 | 🐛 33 | 🌐 C | 📅 2025-05-30 - Serial Flash Universal Driver (using JEDEC's SFDP standard serial (SPI) flash universal driver library).
...
* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,094 | 🐛 96 | 🌐 C | 📅 2026-09-07 - Secure boot for 32-bit Microcontrollers.
...
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 531 | 🐛 11 | 🌐 C | 📅 2026-09-05 - Portable, OS-agnostic, secure bootloader for microcontrollers, supporting firmware authentication and firmware update mechanisms.
...
* [UF2](https://github.com/microsoft/uf2) ⭐ 1,032 | 🐛 24 | 🌐 JavaScript | 📅 2026-02-08 - USB Flashing Format specification for flashing microcontrollers over MSC (Mass Storage Class; aka removable flash drive).
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,705 | 🐛 568 | 🌐 Go | 📅 2026-09-07 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
* [chibicc](https://github.com/rui314/chibicc) ⭐ 11,875 | 🐛 127 | 🌐 C | 📅 2023-10-30 - Yet another small C compiler that implements most C11 features.
* [lcc](https://github.com/drh/lcc) ⭐ 2,617 | 🐛 43 | 🌐 C | 📅 2024-10-06 - Retargetable ANSI C Compiler (fork for [ULP in ESP32](https://github.com/jasonful/lcc) ⭐ 99 | 🐛 3 | 🌐 C | 📅 2021-05-29).
...
* [modm](https://github.com/modm-io/modm) ⭐ 970 | 🐛 68 | 🌐 C++ | 📅 2026-08-07 - Barebone embedded C++20 library generator for AVR, SAM and ARM Cortex-M Microcontrollers (supported 3534 devices).
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 463 | 🐛 67 | 🌐 C | 📅 2026-09-07 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
* [WTX](https://github.com/c410-f3r/wtx) ⭐ 400 | 🐛 6 | 🌐 Rust | 📅 2026-08-30 - A set of web-oriented tools.
...
Please follow [this](https://github.com/iDoka/awesome-embedded-software) ⭐ 1,109 | 🐛 0 | 📅 2026-08-27 root-repo for lastest updates.
