...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,095 | 🐛 65 | 🌐 C++ | 📅 2026-08-16 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [littlefs](https://github.com/littlefs-project/littlefs) ⭐ 6,889 | 🐛 630 | 🌐 C | 📅 2026-03-25 - Little fail-safe filesystem designed for microcontrollers.
...
* [FlashDB](https://github.com/armink/FlashDB) ⭐ 2,820 | 🐛 193 | 🌐 C | 📅 2026-08-15 - Ultra-lightweight database that supports key-value and time series data.
* [UnQLite](https://github.com/symisc/unqlite) ⭐ 2,313 | 🐛 31 | 🌐 C | 📅 2026-05-01 - Embedded NoSQL, Transactional Database Engine.
* [Vedis](https://github.com/symisc/vedis) ⭐ 561 | 🐛 3 | 🌐 C | 📅 2021-11-25 - Embedded Implementation of Redis (an embeddable datastore C library built with over 70 commands similar in concept to Redis but without the networking layer since Vedis run in the same process of the host application).
...
* [nanoPB](https://github.com/nanopb/nanopb) ⭐ 5,521 | 🐛 79 | 🌐 C | 📅 2026-07-24 - Small code-size Protocol Buffers implementation in ANSI C. It is especially suitable for use in microcontrollers, but fits any memory restricted system.
* [nanoMODBUS](https://github.com/debevv/nanoMODBUS) ⭐ 895 | 🐛 37 | 🌐 C | 📅 2026-02-01 - A compact MODBUS RTU/TCP C library for embedded/microcontrollers.
...
* [LiveKit](https://github.com/livekit/client-sdk-esp32) ⭐ 145 | 🐛 14 | 🌐 C | 📅 2026-08-10 - ESP32 SDK for LiveKit: real-time audio, video, and data streaming.
...
* [liquid-dsp](https://github.com/jgaeddert/liquid-dsp) ⭐ 2,281 | 🐛 161 | 🌐 C | 📅 2026-08-16 - Digital signal processing library for software-defined radios.
...
* [pocketfft](https://github.com/mreineck/pocketfft) ⭐ 155 | 🐛 7 | 🌐 C++ | 📅 2026-06-30 - Heavily modified implementation of FFTPack.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,872 | 🐛 1,729 | 🌐 C | 📅 2026-08-14 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 4,996 | 🐛 34 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,806 | 🐛 718 | 🌐 C | 📅 2026-08-16 - Heavily optimized cryptography algorithms for embedded Devices.
...
* [Monocypher](https://github.com/LoupVaillant/Monocypher) ⭐ 776 | 🐛 9 | 🌐 C | 📅 2026-07-28 - Easy to use, easy to deploy, auditable crypto library written in portable C.
...
* [wolfTPM](https://github.com/wolfSSL/wolfTPM) ⭐ 337 | 🐛 2 | 🌐 C | 📅 2026-08-14 - Highly portable TPM 2.0 library, designed for embedded use.
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 3,994 | 🐛 762 | 🌐 C | 📅 2026-08-16 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,503 | 🐛 90 | 🌐 C | 📅 2026-08-16 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
...
* [vsf](https://github.com/vsfteam/vsf) ⭐ 333 | 🐛 1 | 🌐 C | 📅 2026-08-16 - Versaloon Software Framework - a tiny preemptive-capable event-driven incremental software framework for Embedded Systems.
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 23,743 | 🐛 10 | 🌐 C++ | 📅 2026-08-13 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
* [tiny-printf](https://github.com/mpaland/printf) ⭐ 3,042 | 🐛 66 | 🌐 C | 📅 2023-04-03 - Tiny, fast, non-dependent and fully loaded printf implementation for embedded systems. Extensive test suite passing.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,485 | 🐛 49 | 🌐 C++ | 📅 2026-08-08 - Very fast, header-only/compiled, C++ logging library.
* [EasyLogger](https://github.com/armink/EasyLogger) ⭐ 4,715 | 🐛 80 | 🌐 C | 📅 2026-08-13 - Ultra-lightweight (ROM<1.6K, RAM<0.3k), high-performance C/C++ log library.
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,395 | 🐛 224 | 🌐 C | 📅 2026-08-13 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,634 | 🐛 288 | 🌐 C | 📅 2026-06-27 - U8glib library for monochrome displays, version 2.
* [LovyanGFX](https://github.com/lovyan03/LovyanGFX/) ⭐ 1,731 | 🐛 16 | 🌐 C | 📅 2026-08-15 - Display (LCD / OLED / EPD) graphics library (for ESP32 SPI, I2C, 8bitParallel / ESP8266 SPI, I2C / RP2040 SPI / ATSAMD51 SPI and more).
...
* [Embedded-graphics](https://github.com/embedded-graphics/embedded-graphics) ⭐ 1,326 | 🐛 88 | 🌐 Rust | 📅 2026-08-02 - 2D graphics library that is focused on memory constrained embedded devices to draw graphics without using any buffers (Rust).
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,038 | 🐛 243 | 🌐 C | 📅 2026-08-15 - Cross-platform USB stack for embedded system.
...
* [SFUD](https://github.com/armink/SFUD) ⭐ 1,709 | 🐛 33 | 🌐 C | 📅 2025-05-30 - Serial Flash Universal Driver (using JEDEC's SFDP standard serial (SPI) flash universal driver library).
...
* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,029 | 🐛 101 | 🌐 C | 📅 2026-08-13 - Secure boot for 32-bit Microcontrollers.
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,651 | 🐛 566 | 🌐 Go | 📅 2026-08-16 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
* [chibicc](https://github.com/rui314/chibicc) ⭐ 11,816 | 🐛 127 | 🌐 C | 📅 2023-10-30 - Yet another small C compiler that implements most C11 features.
