...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,118 | 🐛 57 | 🌐 C++ | 📅 2026-09-08 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [µClibc-ng](https://github.com/wbx-github/uclibc-ng) ⭐ 216 | 🐛 0 | 🌐 C | 📅 2026-08-31 - Embedded C Library.
...
* [FSMLang](https://github.com/FSMLang/FSMLang) ⭐ 10 | 🐛 19 | 🌐 C | 📅 2026-09-10 - State machine description language with C language generator. Supports flat and hierarchical machines and event subsystem.
...
* [lwmem](https://github.com/MaJerle/lwmem) ⭐ 459 | 🐛 1 | 🌐 C | 📅 2026-08-21 - Lightweight dynamic memory manager library for embedded systems with memory constraints. It implements malloc, calloc, realloc and free functions.
...
* [EmbeddedProto](https://github.com/Embedded-AMS/EmbeddedProto) ⭐ 277 | 🐛 6 | 🌐 C++ | 📅 2026-09-10 -  C++ Protocol Buffers implementation specifically suitable for ARM Cortex-M microcontrollers. It is small, reliable and easy to use.
...
* [LwRB](https://github.com/MaJerle/lwrb) ⭐ 1,533 | 🐛 2 | 🌐 C | 📅 2026-08-21 - Lightweight generic ring buffer manager library.
...
* [littlefs](https://github.com/littlefs-project/littlefs) ⭐ 6,932 | 🐛 633 | 🌐 C | 📅 2026-03-25 - Little fail-safe filesystem designed for microcontrollers.
* [SdFat](https://github.com/greiman/SdFat) ⭐ 1,208 | 🐛 242 | 🌐 C++ | 📅 2025-08-13 - Arduino FAT16/FAT32 exFAT Library.
...
* [FlashDB](https://github.com/armink/FlashDB) ⭐ 2,841 | 🐛 188 | 🌐 C | 📅 2026-08-15 - Ultra-lightweight database that supports key-value and time series data.
...
* [EasyFlash](https://github.com/armink/EasyFlash#1-introduction) ⭐ 2,366 | 🐛 62 | 🌐 C | 📅 2025-03-14 - Lightweight embedded flash memory library.
...
* [nanoPB](https://github.com/nanopb/nanopb) ⭐ 5,559 | 🐛 77 | 🌐 C | 📅 2026-09-08 - Small code-size Protocol Buffers implementation in ANSI C. It is especially suitable for use in microcontrollers, but fits any memory restricted system.
* [nanoMODBUS](https://github.com/debevv/nanoMODBUS) ⭐ 908 | 🐛 37 | 🌐 C | 📅 2026-02-01 - A compact MODBUS RTU/TCP C library for embedded/microcontrollers.
* [TinyFrame](https://github.com/MightyPork/TinyFrame) ⭐ 435 | 🐛 10 | 🌐 C | 📅 2022-08-26 - Simple library for building and parsing data frames for serial interfaces (like UART / RS232).
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 13,037 | 🐛 3 | 🌐 C | 📅 2026-09-09 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [minmea](https://github.com/kosma/minmea) ⭐ 962 | 🐛 14 | 🌐 C | 📅 2026-07-15 - Lightweight GPS NMEA 0183 parser library in pure C.
* [LwGPS](https://github.com/MaJerle/lwgps) ⭐ 506 | 🐛 4 | 🌐 C | 📅 2026-08-21 - Lightweight GPS NMEA parser for embedded systems.
...
* [libCoAP](https://github.com/obgm/libcoap) ⭐ 919 | 🐛 59 | 🌐 C | 📅 2026-09-10 - C implementation of a lightweight application-protocol for devices that are constrained their resources such as computing power, RF range, memory, bandwidth, or network packet sizes. This protocol, CoAP, is standardized by the IETF as RFC 7252.
* [lwpkt](https://github.com/MaJerle/lwpkt) ⭐ 382 | 🐛 3 | 🌐 C | 📅 2026-08-21 - Lightweight packet protocol structure for multi-device communication focused on RS-485.
...
* [liquid-dsp](https://github.com/jgaeddert/liquid-dsp) ⭐ 2,290 | 🐛 163 | 🌐 C | 📅 2026-09-06 - Digital signal processing library for software-defined radios.
* [KISS FFT](https://github.com/mborgerding/kissfft) ⭐ 1,980 | 🐛 40 | 🌐 C | 📅 2026-08-12 - Mixed-radix Fast Fourier Transform based up on the principle, "Keep It Simple, Stupid".
* [CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) ⭐ 1,087 | 🐛 53 | 🌐 C | 📅 2026-09-10 - Embedded compute library for Cortex-M and Cortex-A.
...
* [μTensor](https://github.com/uTensor/uTensor) ⭐ 1,931 | 🐛 56 | 🌐 C++ | 📅 2025-05-10 - TinyML AI inference library.
...
* [edge-agents (ForestHub)](https://github.com/ForestHubAI/edge-agents) ⭐ 101 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - Open-source (AGPL-3.0) 30 MB AI agent runtime for edge devices. Offline by default; GPIO/UART/MQTT as first-class nodes; local SLMs alongside cloud LLMs. Runs on Raspberry Pi, Jetson, STM32MP25.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,953 | 🐛 1,718 | 🌐 C | 📅 2026-09-10 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 5,008 | 🐛 35 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,822 | 🐛 729 | 🌐 C | 📅 2026-09-10 - Heavily optimized cryptography algorithms for embedded Devices.
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,789 | 🐛 58 | 🌐 C | 📅 2026-09-01 - Fairly comprehensive, modular and portable cryptographic toolkit that provides developers with a vast array of well known published block ciphers, one-way hash functions, chaining modes, pseudo-random number generators, public key cryptography and a plethora of other routines.
...
* [wolfTPM](https://github.com/wolfSSL/wolfTPM) ⭐ 344 | 🐛 7 | 🌐 C | 📅 2026-09-10 - Highly portable TPM 2.0 library, designed for embedded use.
...
* [pcg-c-basic](https://github.com/imneme/pcg-c-basic) ⭐ 451 | 🐛 18 | 🌐 C | 📅 2023-11-25 - Code provides a minimal implementation of one member of the PCG family of random number generators, which are fast, statistically excellent, and offer a number of useful features.
* [pcg-c](https://github.com/imneme/pcg-c) ⭐ 426 | 🐛 10 | 🌐 C | 📅 2023-10-26 - Code provides an implementation of the PCG family of random number generators, which are fast, statistically excellent, and offer a number of useful features.

## OS

* [LK kernel](https://github.com/littlekernel/lk) ⭐ 3,675 | 🐛 93 | 🌐 C | 📅 2026-09-10 - The Little Kernel Embedded Operating System is SMP-aware kernel designed for small systems ported to a variety of platforms and cpu architectures.
...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,475 | 🐛 3,824 | 🌐 C | 📅 2026-09-10 - New generation, scalable, optimized, secure RTOS for multiple hardware architectures.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,207 | 🐛 492 | 🌐 C | 📅 2026-09-10 - RT-Thread was born in 2006, it is an open source, neutral, and community-based real-time operating system (RTOS). RT-Thread has Standard version and Nano version. For resource-constrained microcontroller (MCU) systems, the NANO kernel version that requires only 3KB Flash and 1.2KB RAM memory resources can be tailored with easy-to-use tools; And for resource-rich IoT devices, RT-Thread can use the on-line software package management tool, together with system configuration tools, to achieve intuitive and rapid modular cutting, seamlessly import rich software packages, thus achieving complex functions like Android's graphical interface and touch sliding effects, smart voice interaction effects, and so on.
* 🔝[FreeRTOS™](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,783 | 🐛 35 | 🌐 C | 📅 2026-08-26 - FreeRTOS.
* [Tock Embedded OS](https://github.com/tock/tock) ⭐ 6,440 | 🐛 216 | 🌐 Rust | 📅 2026-09-10 - Embedded operating system designed for running multiple concurrent, mutually distrustful applications on low-memory and low-power microcontrollers *(Rust)*.
* [RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,791 | 🐛 878 | 🌐 C | 📅 2026-09-10 - Real-time multi-threading operating system that supports a range of devices that are typically found in the Internet of Things (IoT): 8-bit, 16-bit and 32-bit microcontrollers. RIOT is based on the following design principles: energy-efficiency, real-time capabilities, small memory footprint, modularity, and uniform API access, independent of the underlying hardware (this API offers partial POSIX compliance).
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 4,028 | 🐛 758 | 🌐 C | 📅 2026-09-10 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,524 | 🐛 78 | 🌐 C | 📅 2026-09-10 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
* [embox](https://github.com/embox/embox) ⭐ 1,594 | 🐛 216 | 🌐 C | 📅 2026-09-10 - Configurable RTOS designed for resource constrained and embedded systems. Embox main idea is using Linux software without Linux.
* [QP/C](https://github.com/QuantumLeaps/qpc) ⭐ 1,367 | 🐛 4 | 🌐 C | 📅 2026-08-28 - Real-time embedded framework/RTOS for embedded systems based on active objects (actors) and hierarchical state machines (FuSa, MISRA-C 2023 compliance).
...
* [ChibiOS/RT](https://github.com/ChibiOS/ChibiOS) ⭐ 863 | 🐛 21 | 🌐 C | 📅 2026-05-31 - Compact and fast real-time operating system supporting multiple architectures designed for embedded applications on microcontrollers of 8-, 16-, and 32-bits.
* [µC/OS-II](https://github.com/weston-embedded/uC-OS2) ⭐ 739 | 🐛 3 | 🌐 C | 📅 2023-01-05 - Preemptive, highly portable, and scalable real-time kernels. Designed for ease of use on a huge number of CPU architectures.
...
* [vsf](https://github.com/vsfteam/vsf) ⭐ 336 | 🐛 1 | 🌐 C | 📅 2026-09-10 - Versaloon Software Framework - a tiny preemptive-capable event-driven incremental software framework for Embedded Systems.
* [lwevt](https://github.com/MaJerle/lwevt) ⭐ 198 | 🐛 0 | 🌐 C | 📅 2026-08-21 - Lightweight event management system for embedded systems.
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 25,717 | 🐛 9 | 🌐 C++ | 📅 2026-09-09 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
...
* [tiny-printf new](https://github.com/eyalroz/printf) ⭐ 638 | 🐛 13 | 🌐 C | 📅 2026-09-09 - Enhanced and maintained fork of `tiny-printf`. Tiny, fast(ish), self-contained and fully loaded printf, sprinf etc.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,587 | 🐛 47 | 🌐 C++ | 📅 2026-09-05 - Very fast, header-only/compiled, C++ logging library.
* [EasyLogger](https://github.com/armink/EasyLogger) ⭐ 4,745 | 🐛 81 | 🌐 C | 📅 2026-08-13 - Ultra-lightweight (ROM<1.6K, RAM<0.3k), high-performance C/C++ log library.
* [trice](https://github.com/rokath/trice) ⭐ 992 | 🐛 0 | 🌐 Go | 📅 2026-09-10 - Super fast and tiny embedded device C printf-like trace code (works also inside interrupts) and real-time PC logging (trace ID visualization).
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,654 | 🐛 131 | 🌐 C | 📅 2026-09-10 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,673 | 🐛 279 | 🌐 C | 📅 2026-08-23 - U8glib library for monochrome displays, version 2.
* [LovyanGFX](https://github.com/lovyan03/LovyanGFX/) ⭐ 1,755 | 🐛 16 | 🌐 C | 📅 2026-09-10 - Display (LCD / OLED / EPD) graphics library (for ESP32 SPI, I2C, 8bitParallel / ESP8266 SPI, I2C / RP2040 SPI / ATSAMD51 SPI and more).
...
* [GUIX](https://github.com/azure-rtos/guix) ⭐ 405 | 🐛 25 | 🌐 C | 📅 2026-08-28 - Provides a complete, embedded graphical user interface (GUI) library and design environment, facilitating the creation and maintenance of all graphical elements needed by your device.
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,086 | 🐛 270 | 🌐 C | 📅 2026-09-10 - Cross-platform USB stack for embedded system.
...
* [CanBoot](https://github.com/Arksine/CanBoot) ⭐ 674 | 🐛 82 | 🌐 C | 📅 2026-03-20 -  Can Bootloader for MCUs (Currently lpc176x, stm32 and rp2040 MCUs are supported).
* [libcanard](https://github.com/UAVCAN/libcanard) ⭐ 447 | 🐛 0 | 🌐 C | 📅 2026-07-02 - Compact implementation of the UAVCAN/CAN protocol in C for high-integrity real-time embedded systems.
...
* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,099 | 🐛 98 | 🌐 C | 📅 2026-09-10 - Secure boot for 32-bit Microcontrollers.
...
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 533 | 🐛 11 | 🌐 C | 📅 2026-09-10 - Portable, OS-agnostic, secure bootloader for microcontrollers, supporting firmware authentication and firmware update mechanisms.
...
* [SWupdate](https://github.com/sbabic/swupdate) ⭐ 1,866 | 🐛 11 | 🌐 C | 📅 2026-08-19 - Software Update for Embedded Linux Devices to update system in field. SWUpdate supports local and OTA updates, multiple update strategies and it is designed with security in mind.
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,714 | 🐛 553 | 🌐 Go | 📅 2026-09-10 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
* [chibicc](https://github.com/rui314/chibicc) ⭐ 11,885 | 🐛 127 | 🌐 C | 📅 2023-10-30 - Yet another small C compiler that implements most C11 features.
...
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 464 | 🐛 64 | 🌐 C | 📅 2026-09-10 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
