...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,121 | 🐛 59 | 🌐 C++ | 📅 2026-09-18 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [littlefs](https://github.com/littlefs-project/littlefs) ⭐ 6,945 | 🐛 633 | 🌐 C | 📅 2026-03-25 - Little fail-safe filesystem designed for microcontrollers.
...
* [nanoPB](https://github.com/nanopb/nanopb) ⭐ 5,566 | 🐛 77 | 🌐 C | 📅 2026-09-08 - Small code-size Protocol Buffers implementation in ANSI C. It is especially suitable for use in microcontrollers, but fits any memory restricted system.
...
* [LiveKit](https://github.com/livekit/client-sdk-esp32) ⭐ 150 | 🐛 12 | 🌐 C | 📅 2026-09-18 - ESP32 SDK for LiveKit: real-time audio, video, and data streaming.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 13,041 | 🐛 4 | 🌐 C | 📅 2026-09-18 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [minmea](https://github.com/kosma/minmea) ⭐ 965 | 🐛 14 | 🌐 C | 📅 2026-07-15 - Lightweight GPS NMEA 0183 parser library in pure C.
...
* [libCoAP](https://github.com/obgm/libcoap) ⭐ 919 | 🐛 56 | 🌐 C | 📅 2026-09-18 - C implementation of a lightweight application-protocol for devices that are constrained their resources such as computing power, RF range, memory, bandwidth, or network packet sizes. This protocol, CoAP, is standardized by the IETF as RFC 7252.
...
* [CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) ⭐ 1,098 | 🐛 51 | 🌐 C | 📅 2026-09-10 - Embedded compute library for Cortex-M and Cortex-A.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,960 | 🐛 1,725 | 🌐 C | 📅 2026-09-17 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 5,008 | 🐛 35 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,828 | 🐛 747 | 🌐 C | 📅 2026-09-18 - Heavily optimized cryptography algorithms for embedded Devices.
...
* [Monocypher](https://github.com/LoupVaillant/Monocypher) ⭐ 784 | 🐛 10 | 🌐 C | 📅 2026-07-28 - Easy to use, easy to deploy, auditable crypto library written in portable C.
...
* [trussed](https://github.com/trussed-dev/trussed) ⭐ 504 | 🐛 18 | 🌐 Rust | 📅 2026-09-17 - Minimal, modular way to write cryptographic applications on microcontroller platforms (Rust).
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 4,040 | 🐛 755 | 🌐 C | 📅 2026-09-18 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,527 | 🐛 79 | 🌐 C | 📅 2026-09-18 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
* [embox](https://github.com/embox/embox) ⭐ 1,596 | 🐛 217 | 🌐 C | 📅 2026-09-18 - Configurable RTOS designed for resource constrained and embedded systems. Embox main idea is using Linux software without Linux.
...
* [ChibiOS/RT](https://github.com/ChibiOS/ChibiOS) ⭐ 863 | 🐛 27 | 🌐 C | 📅 2026-05-31 - Compact and fast real-time operating system supporting multiple architectures designed for embedded applications on microcontrollers of 8-, 16-, and 32-bits.
* [µC/OS-II](https://github.com/weston-embedded/uC-OS2) ⭐ 741 | 🐛 3 | 🌐 C | 📅 2023-01-05 - Preemptive, highly portable, and scalable real-time kernels. Designed for ease of use on a huge number of CPU architectures.
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 25,790 | 🐛 14 | 🌐 C++ | 📅 2026-09-16 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,612 | 🐛 54 | 🌐 C++ | 📅 2026-09-05 - Very fast, header-only/compiled, C++ logging library.
...
* [trice](https://github.com/rokath/trice) ⭐ 996 | 🐛 0 | 🌐 Go | 📅 2026-09-18 - Super fast and tiny embedded device C printf-like trace code (works also inside interrupts) and real-time PC logging (trace ID visualization).
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,717 | 🐛 135 | 🌐 C | 📅 2026-09-18 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,684 | 🐛 280 | 🌐 C | 📅 2026-09-14 - U8glib library for monochrome displays, version 2.
* [LovyanGFX](https://github.com/lovyan03/LovyanGFX/) ⭐ 1,760 | 🐛 15 | 🌐 C | 📅 2026-09-18 - Display (LCD / OLED / EPD) graphics library (for ESP32 SPI, I2C, 8bitParallel / ESP8266 SPI, I2C / RP2040 SPI / ATSAMD51 SPI and more).
...
* [HAGL](https://github.com/tuupola/hagl) ⭐ 467 | 🐛 20 | 🌐 C | 📅 2026-09-17 - Lightweight Hardware Agnostic Graphics Library for embedded devices. It supports basic geometric primitives, bitmaps, blitting, fixed width fonts. Library tries to stay lightweight but targets reasonably powerful microchips such as ESP32. There is no dynamic allocation.
* [GUIX](https://github.com/azure-rtos/guix) ⭐ 405 | 🐛 25 | 🌐 C | 📅 2026-09-15 - Provides a complete, embedded graphical user interface (GUI) library and design environment, facilitating the creation and maintenance of all graphical elements needed by your device.
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,109 | 🐛 271 | 🌐 C | 📅 2026-09-18 - Cross-platform USB stack for embedded system.
...
* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,118 | 🐛 95 | 🌐 C | 📅 2026-09-18 - Secure boot for 32-bit Microcontrollers.
...
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 535 | 🐛 19 | 🌐 C | 📅 2026-09-17 - Portable, OS-agnostic, secure bootloader for microcontrollers, supporting firmware authentication and firmware update mechanisms.
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,735 | 🐛 545 | 🌐 Go | 📅 2026-09-18 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
* [chibicc](https://github.com/rui314/chibicc) ⭐ 11,897 | 🐛 127 | 🌐 C | 📅 2023-10-30 - Yet another small C compiler that implements most C11 features.
...
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 465 | 🐛 59 | 🌐 C | 📅 2026-09-18 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
