...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,127 | 🐛 51 | 🌐 C++ | 📅 2026-09-23 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [ctl](https://github.com/rurban/ctl) ⭐ 289 | 🐛 0 | 🌐 C | 📅 2026-09-23 - C Container Template Library. There is a fast compiling, type safe, header only, template-like container library for ISO C99/C11.
...
* [FSMLang](https://github.com/FSMLang/FSMLang) ⭐ 10 | 🐛 17 | 🌐 C | 📅 2026-09-22 - State machine description language with C language generator. Supports flat and hierarchical machines and event subsystem.
...
* [littlefs](https://github.com/littlefs-project/littlefs) ⭐ 6,947 | 🐛 633 | 🌐 C | 📅 2026-03-25 - Little fail-safe filesystem designed for microcontrollers.
...
* [LevelX](https://github.com/azure-rtos/levelx) ⭐ 153 | 🐛 30 | 🌐 C | 📅 2026-09-15 - Provides Flash Wear Leveling for FileX and Stand Alone purposes.
...
* [FlashDB](https://github.com/armink/FlashDB) ⭐ 2,850 | 🐛 188 | 🌐 C | 📅 2026-09-23 - Ultra-lightweight database that supports key-value and time series data.
...
* [nanoPB](https://github.com/nanopb/nanopb) ⭐ 5,569 | 🐛 78 | 🌐 C | 📅 2026-09-08 - Small code-size Protocol Buffers implementation in ANSI C. It is especially suitable for use in microcontrollers, but fits any memory restricted system.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 13,049 | 🐛 5 | 🌐 C | 📅 2026-09-23 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [TinyGSM](https://github.com/vshymanskyy/TinyGSM) ⭐ 2,217 | 🐛 354 | 🌐 C++ | 📅 2026-07-21 - Small Arduino library for GSM modules, that just works.
...
* [libCoAP](https://github.com/obgm/libcoap) ⭐ 919 | 🐛 54 | 🌐 C | 📅 2026-09-23 - C implementation of a lightweight application-protocol for devices that are constrained their resources such as computing power, RF range, memory, bandwidth, or network packet sizes. This protocol, CoAP, is standardized by the IETF as RFC 7252.
...
* [CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) ⭐ 1,100 | 🐛 51 | 🌐 C | 📅 2026-09-10 - Embedded compute library for Cortex-M and Cortex-A.
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,966 | 🐛 1,729 | 🌐 C | 📅 2026-09-22 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 5,006 | 🐛 35 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,832 | 🐛 735 | 🌐 C | 📅 2026-09-23 - Heavily optimized cryptography algorithms for embedded Devices.
...
* [wolfTPM](https://github.com/wolfSSL/wolfTPM) ⭐ 345 | 🐛 4 | 🌐 C | 📅 2026-09-21 - Highly portable TPM 2.0 library, designed for embedded use.
...
* [LK kernel](https://github.com/littlekernel/lk) ⭐ 3,694 | 🐛 92 | 🌐 C | 📅 2026-09-20 - The Little Kernel Embedded Operating System is SMP-aware kernel designed for small systems ported to a variety of platforms and cpu architectures.
...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,595 | 🐛 4,018 | 🌐 C | 📅 2026-09-23 - New generation, scalable, optimized, secure RTOS for multiple hardware architectures.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,237 | 🐛 492 | 🌐 C | 📅 2026-09-23 - RT-Thread was born in 2006, it is an open source, neutral, and community-based real-time operating system (RTOS). RT-Thread has Standard version and Nano version. For resource-constrained microcontroller (MCU) systems, the NANO kernel version that requires only 3KB Flash and 1.2KB RAM memory resources can be tailored with easy-to-use tools; And for resource-rich IoT devices, RT-Thread can use the on-line software package management tool, together with system configuration tools, to achieve intuitive and rapid modular cutting, seamlessly import rich software packages, thus achieving complex functions like Android's graphical interface and touch sliding effects, smart voice interaction effects, and so on.
* 🔝[FreeRTOS™](https://github.com/FreeRTOS/FreeRTOS) ⭐ 7,826 | 🐛 36 | 🌐 C | 📅 2026-08-26 - FreeRTOS.
* [Tock Embedded OS](https://github.com/tock/tock) ⭐ 6,446 | 🐛 215 | 🌐 Rust | 📅 2026-09-23 - Embedded operating system designed for running multiple concurrent, mutually distrustful applications on low-memory and low-power microcontrollers *(Rust)*.
* [RIOT](https://github.com/RIOT-OS/RIOT) ⭐ 5,805 | 🐛 892 | 🌐 C | 📅 2026-09-23 - Real-time multi-threading operating system that supports a range of devices that are typically found in the Internet of Things (IoT): 8-bit, 16-bit and 32-bit microcontrollers. RIOT is based on the following design principles: energy-efficiency, real-time capabilities, small memory footprint, modularity, and uniform API access, independent of the underlying hardware (this API offers partial POSIX compliance).
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 4,046 | 🐛 811 | 🌐 C | 📅 2026-09-23 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,531 | 🐛 63 | 🌐 C | 📅 2026-09-23 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
* [embox](https://github.com/embox/embox) ⭐ 1,595 | 🐛 216 | 🌐 C | 📅 2026-09-23 - Configurable RTOS designed for resource constrained and embedded systems. Embox main idea is using Linux software without Linux.
* [QP/C](https://github.com/QuantumLeaps/qpc) ⭐ 1,375 | 🐛 4 | 🌐 C | 📅 2026-09-22 - Real-time embedded framework/RTOS for embedded systems based on active objects (actors) and hierarchical state machines (FuSa, MISRA-C 2023 compliance).
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 25,803 | 🐛 12 | 🌐 C++ | 📅 2026-09-21 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
* [tiny-printf](https://github.com/mpaland/printf) ⭐ 3,067 | 🐛 66 | 🌐 C | 📅 2023-04-03 - Tiny, fast, non-dependent and fully loaded printf implementation for embedded systems. Extensive test suite passing.
* [nanoprintf](https://github.com/charlesnicholson/nanoprintf) ⭐ 851 | 🐛 7 | 🌐 C++ | 📅 2026-09-07 - The smallest public printf implementation for its feature set.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,621 | 🐛 53 | 🌐 C++ | 📅 2026-09-22 - Very fast, header-only/compiled, C++ logging library.
...
* [trice](https://github.com/rokath/trice) ⭐ 999 | 🐛 1 | 🌐 Go | 📅 2026-09-23 - Super fast and tiny embedded device C printf-like trace code (works also inside interrupts) and real-time PC logging (trace ID visualization).
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,740 | 🐛 130 | 🌐 C | 📅 2026-09-23 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,691 | 🐛 281 | 🌐 C | 📅 2026-09-14 - U8glib library for monochrome displays, version 2.
* [LovyanGFX](https://github.com/lovyan03/LovyanGFX/) ⭐ 1,763 | 🐛 16 | 🌐 C | 📅 2026-09-23 - Display (LCD / OLED / EPD) graphics library (for ESP32 SPI, I2C, 8bitParallel / ESP8266 SPI, I2C / RP2040 SPI / ATSAMD51 SPI and more).
...
* [Embedded-graphics](https://github.com/embedded-graphics/embedded-graphics) ⭐ 1,339 | 🐛 91 | 🌐 Rust | 📅 2026-08-02 - 2D graphics library that is focused on memory constrained embedded devices to draw graphics without using any buffers (Rust).
...
* [GUIX](https://github.com/azure-rtos/guix) ⭐ 405 | 🐛 30 | 🌐 C | 📅 2026-09-15 - Provides a complete, embedded graphical user interface (GUI) library and design environment, facilitating the creation and maintenance of all graphical elements needed by your device.
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,119 | 🐛 272 | 🌐 C | 📅 2026-09-23 - Cross-platform USB stack for embedded system.
...
* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,128 | 🐛 92 | 🌐 C | 📅 2026-09-22 - Secure boot for 32-bit Microcontrollers.
...
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 537 | 🐛 14 | 🌐 C | 📅 2026-09-23 - Portable, OS-agnostic, secure bootloader for microcontrollers, supporting firmware authentication and firmware update mechanisms.
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,772 | 🐛 530 | 🌐 Go | 📅 2026-09-23 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
* [chibicc](https://github.com/rui314/chibicc) ⭐ 11,907 | 🐛 127 | 🌐 C | 📅 2023-10-30 - Yet another small C compiler that implements most C11 features.
...
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 465 | 🐛 59 | 🌐 C | 📅 2026-09-23 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
