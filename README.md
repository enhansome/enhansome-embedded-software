...
* [ETLCPP](https://github.com/ETLCPP/etl) ⭐ 3,127 | 🐛 59 | 🌐 C++ | 📅 2026-09-22 - Embedded Template Library where the user can declare the size, or maximum size of any object upfront.
...
* [ctl](https://github.com/rurban/ctl) ⭐ 289 | 🐛 2 | 🌐 C | 📅 2026-09-22 - C Container Template Library. There is a fast compiling, type safe, header only, template-like container library for ISO C99/C11.
...
* [FSMLang](https://github.com/FSMLang/FSMLang) ⭐ 10 | 🐛 19 | 🌐 C | 📅 2026-09-22 - State machine description language with C language generator. Supports flat and hierarchical machines and event subsystem.
...
* [LwRB](https://github.com/MaJerle/lwrb) ⭐ 1,538 | 🐛 2 | 🌐 C | 📅 2026-09-13 - Lightweight generic ring buffer manager library.
...
* [littlefs](https://github.com/littlefs-project/littlefs) ⭐ 6,946 | 🐛 633 | 🌐 C | 📅 2026-03-25 - Little fail-safe filesystem designed for microcontrollers.
...
* [FlashDB](https://github.com/armink/FlashDB) ⭐ 2,850 | 🐛 188 | 🌐 C | 📅 2026-09-22 - Ultra-lightweight database that supports key-value and time series data.
...
* [EasyFlash](https://github.com/armink/EasyFlash#1-introduction) ⭐ 2,371 | 🐛 62 | 🌐 C | 📅 2025-03-14 - Lightweight embedded flash memory library.
...
* [mongoose](https://github.com/cesanta/mongoose) ⭐ 13,048 | 🐛 3 | 🌐 C | 📅 2026-09-22 - Embedded Web Server and Embedded Networking Library. It implements event-driven non-blocking APIs for TCP, UDP, HTTP, WebSocket, MQTT.
...
* [Paho MQTT](https://github.com/eclipse/paho.mqtt.embedded-c) ⭐ 1,543 | 🐛 93 | 🌐 C | 📅 2026-07-03 - C client library for embedded systems.
...
* [libCoAP](https://github.com/obgm/libcoap) ⭐ 919 | 🐛 56 | 🌐 C | 📅 2026-09-22 - C implementation of a lightweight application-protocol for devices that are constrained their resources such as computing power, RF range, memory, bandwidth, or network packet sizes. This protocol, CoAP, is standardized by the IETF as RFC 7252.
...
* [liquid-dsp](https://github.com/jgaeddert/liquid-dsp) ⭐ 2,298 | 🐛 163 | 🌐 C | 📅 2026-09-12 - Digital signal processing library for software-defined radios.
* [KISS FFT](https://github.com/mborgerding/kissfft) ⭐ 1,983 | 🐛 40 | 🌐 C | 📅 2026-08-12 - Mixed-radix Fast Fourier Transform based up on the principle, "Keep It Simple, Stupid".
...
* [mbedTLS](https://github.com/Mbed-TLS/mbedtls) ⭐ 6,963 | 🐛 1,725 | 🌐 C | 📅 2026-09-22 - Open source, portable, easy to use, readable and flexible TLS library, and reference implementation of the PSA Cryptography API.
* [tiny-AES-c](https://github.com/kokke/tiny-AES-c) ⭐ 5,007 | 🐛 35 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C.
* 🔝[trezor-crypto](https://github.com/trezor/trezor-firmware/tree/master/crypto) ⭐ 1,832 | 🐛 740 | 🌐 C | 📅 2026-09-22 - Heavily optimized cryptography algorithms for embedded Devices.
...
* [Apache NuttX](https://github.com/apache/incubator-nuttx) ⭐ 4,044 | 🐛 755 | 🌐 C | 📅 2026-09-22 - Apache NuttX is a mature, real-time embedded operating system (RTOS).
* [Azure RTOS ThreadX](https://github.com/azure-rtos/threadx) ⭐ 3,531 | 🐛 78 | 🌐 C | 📅 2026-09-21 - Advanced real-time operating system (RTOS) designed specifically for deeply embedded applications.
* [embox](https://github.com/embox/embox) ⭐ 1,595 | 🐛 216 | 🌐 C | 📅 2026-09-22 - Configurable RTOS designed for resource constrained and embedded systems. Embox main idea is using Linux software without Linux.
* [QP/C](https://github.com/QuantumLeaps/qpc) ⭐ 1,374 | 🐛 4 | 🌐 C | 📅 2026-08-28 - Real-time embedded framework/RTOS for embedded systems based on active objects (actors) and hierarchical state machines (FuSa, MISRA-C 2023 compliance).
...
* [vsf](https://github.com/vsfteam/vsf) ⭐ 339 | 🐛 1 | 🌐 C | 📅 2026-09-22 - Versaloon Software Framework - a tiny preemptive-capable event-driven incremental software framework for Embedded Systems.
...
* [fmt](https://github.com/fmtlib/fmt) ⭐ 25,800 | 🐛 12 | 🌐 C++ | 📅 2026-09-21 - Modern formatting library providing a fast and safe alternative to C stdio and C++ iostreams.
* [tiny-printf](https://github.com/mpaland/printf) ⭐ 3,064 | 🐛 66 | 🌐 C | 📅 2023-04-03 - Tiny, fast, non-dependent and fully loaded printf implementation for embedded systems. Extensive test suite passing.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,620 | 🐛 57 | 🌐 C++ | 📅 2026-09-05 - Very fast, header-only/compiled, C++ logging library.
...
* [trice](https://github.com/rokath/trice) ⭐ 999 | 🐛 1 | 🌐 Go | 📅 2026-09-22 - Super fast and tiny embedded device C printf-like trace code (works also inside interrupts) and real-time PC logging (trace ID visualization).
...
* [lvgl](https://github.com/lvgl/lvgl) ⭐ 24,736 | 🐛 136 | 🌐 C | 📅 2026-09-22 - Powerful and easy-to-use embedded GUI with many widgets, advanced visual effects (opacity, antialiasing, animations) and low memory requirements (16K RAM, 64K Flash).
* 🔝[u8g2](https://github.com/olikraus/u8g2) ⭐ 6,690 | 🐛 281 | 🌐 C | 📅 2026-09-14 - U8glib library for monochrome displays, version 2.
* [LovyanGFX](https://github.com/lovyan03/LovyanGFX/) ⭐ 1,762 | 🐛 15 | 🌐 C | 📅 2026-09-22 - Display (LCD / OLED / EPD) graphics library (for ESP32 SPI, I2C, 8bitParallel / ESP8266 SPI, I2C / RP2040 SPI / ATSAMD51 SPI and more).
...
* [GUIX](https://github.com/azure-rtos/guix) ⭐ 405 | 🐛 26 | 🌐 C | 📅 2026-09-15 - Provides a complete, embedded graphical user interface (GUI) library and design environment, facilitating the creation and maintenance of all graphical elements needed by your device.
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,116 | 🐛 267 | 🌐 C | 📅 2026-09-22 - Cross-platform USB stack for embedded system.
...
* [mcuboot](https://github.com/mcu-tools/mcuboot) ⭐ 2,126 | 🐛 94 | 🌐 C | 📅 2026-09-22 - Secure boot for 32-bit Microcontrollers.
* [OpenBLT](https://github.com/feaser/openblt) ⭐ 974 | 🐛 0 | 🌐 C | 📅 2026-09-19 - Open source bootloader for STM32, XMC, HCS12 and other microcontroller targets. It supports communication interfaces such as: RS232, CAN, USB, TCP/IP and it ships with the easy-to-use [MicroBoot](https://www.feaser.com/openblt/doku.php?id=manual:microboot) PC tool for initiating and monitoring the firmware update. Performing firmware updates directly from an SD-card is also supported.
* [wolfBoot](https://github.com/wolfSSL/wolfBoot) ⭐ 537 | 🐛 14 | 🌐 C | 📅 2026-09-22 - Portable, OS-agnostic, secure bootloader for microcontrollers, supporting firmware authentication and firmware update mechanisms.
* [TinyUF2](https://github.com/adafruit/tinyuf2) ⭐ 472 | 🐛 15 | 🌐 C | 📅 2026-08-13 - Bootloader based on TinyUSB for embedded devices such as ESP32, STM32 and iMX RT10xx.

### Firmware updates

* [SWupdate](https://github.com/sbabic/swupdate) ⭐ 1,874 | 🐛 11 | 🌐 C | 📅 2026-08-19 - Software Update for Embedded Linux Devices to update system in field. SWUpdate supports local and OTA updates, multiple update strategies and it is designed with security in mind.
...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,768 | 🐛 532 | 🌐 Go | 📅 2026-09-22 - Go compiler for small things: Microcontrollers, WebAssembly (WASM/WASI), and command-line tools (Based on LLVM).
* [chibicc](https://github.com/rui314/chibicc) ⭐ 11,904 | 🐛 127 | 🌐 C | 📅 2023-10-30 - Yet another small C compiler that implements most C11 features.
...
* [modm](https://github.com/modm-io/modm) ⭐ 981 | 🐛 66 | 🌐 C++ | 📅 2026-09-22 - Barebone embedded C++20 library generator for AVR, SAM and ARM Cortex-M Microcontrollers (supported 3534 devices).
* [Apache NuttX Apps](https://github.com/apache/incubator-nuttx-apps) ⭐ 465 | 🐛 58 | 🌐 C | 📅 2026-09-22 - Collection of tools, shells, network utilities, libraries, interpreters and can be used with the NuttX RTOS.
